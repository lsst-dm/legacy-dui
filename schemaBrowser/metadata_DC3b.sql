...
CREATE TABLE AAA_Version_DC3b_3_1_90 (version CHAR);
...
SET tableId = 4, name = "Durations",
	...
	INSERT INTO md_Column
	SET columnId = 89, tableId = 4, name = "workerid",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 90, tableId = 4, name = "stagename",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 91, tableId = 4, name = "SLICEID",
		type = "INTEGER",
		notNull = 0,
		defaultValue = "-1",
		displayOrder = 6;
	...
	INSERT INTO md_Column
	SET columnId = 92, tableId = 4, name = "duration",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 93, tableId = 4, name = "HOSTID",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 94, tableId = 4, name = "LOOPNUM",
		type = "INTEGER",
		notNull = 0,
		defaultValue = "-1",
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 95, tableId = 4, name = "STAGEID",
		type = "INTEGER",
		notNull = 0,
		defaultValue = "-1",
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 96, tableId = 4, name = "PIPELINE",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 11;

	INSERT INTO md_Column
	SET columnId = 97, tableId = 4, name = "COMMENT",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 12;

	INSERT INTO md_Column
	SET columnId = 98, tableId = 4, name = "start",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 13;

	INSERT INTO md_Column
	SET columnId = 99, tableId = 4, name = "userduration",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 14;

	INSERT INTO md_Column
	SET columnId = 100, tableId = 4, name = "systemduration",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 15;
...
SET tableId = 5, name = "Filter";
	...
	INSERT INTO md_Column
	SET columnId = 101, tableId = 5, name = "filterId",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 102, tableId = 5, name = "filterName",
	...
	INSERT INTO md_Column
	SET columnId = 103, tableId = 5, name = "photClam",
	...
	INSERT INTO md_Column
	SET columnId = 104, tableId = 5, name = "photBW",
...
SET tableId = 6, name = "ForcedSource",
	...
	INSERT INTO md_Column
	SET columnId = 105, tableId = 6, name = "objectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 106, tableId = 6, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 107, tableId = 6, name = "sky",
		description = "Sky background.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 108, tableId = 6, name = "skySigma",
		description = "Uncertainty of sky.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 109, tableId = 6, name = "flux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 110, tableId = 6, name = "flux_PS_Sigma",
		description = "Uncertainty of flux_PS.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 6;
	...
	INSERT INTO md_Column
	SET columnId = 111, tableId = 6, name = "flux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 112, tableId = 6, name = "flux_SG_Sigma",
		description = "Uncertainty of flux_SG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 8;
	...
	INSERT INTO md_Column
	SET columnId = 113, tableId = 6, name = "flux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 114, tableId = 6, name = "flux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 115, tableId = 6, name = "psfLnL",
		description = "ln(likelihood) of being a PSF.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 116, tableId = 6, name = "modelLSLnL",
	...
	INSERT INTO md_Column
	SET columnId = 117, tableId = 6, name = "modelSGLnL",
	...
	INSERT INTO md_Column
	SET columnId = 118, tableId = 6, name = "flags",
		description = "Flags.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 119, tableId = 6, name = "_chunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 120, tableId = 6, name = "_subChunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 16;
...
SET tableId = 7, name = "FpaMetadata",
	...
	INSERT INTO md_Column
	SET columnId = 121, tableId = 7, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 122, tableId = 7, name = "exposureType",
	...
	INSERT INTO md_Column
	SET columnId = 123, tableId = 7, name = "metadataKey",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 124, tableId = 7, name = "metadataValue",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 8, name = "Logs",
	...
	INSERT INTO md_Column
	SET columnId = 125, tableId = 8, name = "id",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 126, tableId = 8, name = "HOSTID",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 127, tableId = 8, name = "RUNID",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 128, tableId = 8, name = "LOG",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 129, tableId = 8, name = "workerid",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 130, tableId = 8, name = "stagename",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 131, tableId = 8, name = "SLICEID",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 132, tableId = 8, name = "STAGEID",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 133, tableId = 8, name = "LOOPNUM",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 134, tableId = 8, name = "STATUS",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 10;

	INSERT INTO md_Column
	SET columnId = 135, tableId = 8, name = "LEVEL",
		type = "INTEGER",
		notNull = 0,
		defaultValue = "9999",
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 136, tableId = 8, name = "DATE",
		type = "VARCHAR(30)",
		notNull = 0,
		displayOrder = 12;

	INSERT INTO md_Column
	SET columnId = 137, tableId = 8, name = "TIMESTAMP",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 13;

	INSERT INTO md_Column
	SET columnId = 138, tableId = 8, name = "node",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 14;

	INSERT INTO md_Column
	SET columnId = 139, tableId = 8, name = "custom",
		type = "VARCHAR(4096)",
		notNull = 0,
		displayOrder = 15;

	INSERT INTO md_Column
	SET columnId = 140, tableId = 8, name = "timereceived",
		type = "TIMESTAMP",
		notNull = 1,
	...
	INSERT INTO md_Column
	SET columnId = 141, tableId = 8, name = "visitid",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 17;

	INSERT INTO md_Column
	SET columnId = 142, tableId = 8, name = "COMMENT",
		type = "TEXT",
		notNull = 0,
		displayOrder = 18;

	INSERT INTO md_Column
	SET columnId = 143, tableId = 8, name = "PIPELINE",
		type = "VARCHAR(80)",
		notNull = 0,
		displayOrder = 19;

	INSERT INTO md_Column
	SET columnId = 144, tableId = 8, name = "TYPE",
		type = "VARCHAR(5)",
		notNull = 0,
		displayOrder = 20;

	INSERT INTO md_Column
	SET columnId = 145, tableId = 8, name = "EVENTTIME",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 21;

	INSERT INTO md_Column
	SET columnId = 146, tableId = 8, name = "PUBTIME",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 22;

	INSERT INTO md_Column
	SET columnId = 147, tableId = 8, name = "usertime",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 23;

	INSERT INTO md_Column
	SET columnId = 148, tableId = 8, name = "systemtime",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 24;
...
SET tableId = 9, name = "MovingObject",
	...
	INSERT INTO md_Column
	SET columnId = 149, tableId = 9, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 150, tableId = 9, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 151, tableId = 9, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 152, tableId = 9, name = "taxonomicTypeId",
	...
	INSERT INTO md_Column
	SET columnId = 153, tableId = 9, name = "ssmObjectName",
	...
	INSERT INTO md_Column
	SET columnId = 154, tableId = 9, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 155, tableId = 9, name = "e",
	...
	INSERT INTO md_Column
	SET columnId = 156, tableId = 9, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 157, tableId = 9, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 158, tableId = 9, name = "meanAnom",
	...
	INSERT INTO md_Column
	SET columnId = 159, tableId = 9, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 160, tableId = 9, name = "distPeri",
	...
	INSERT INTO md_Column
	SET columnId = 161, tableId = 9, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 162, tableId = 9, name = "epoch",
	...
	INSERT INTO md_Column
	SET columnId = 163, tableId = 9, name = "h_v",
	...
	INSERT INTO md_Column
	SET columnId = 164, tableId = 9, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 165, tableId = 9, name = "rotationPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 166, tableId = 9, name = "rotationEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 167, tableId = 9, name = "albedo",
	...
	INSERT INTO md_Column
	SET columnId = 168, tableId = 9, name = "poleLat",
	...
	INSERT INTO md_Column
	SET columnId = 169, tableId = 9, name = "poleLon",
	...
	INSERT INTO md_Column
	SET columnId = 170, tableId = 9, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 171, tableId = 9, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 172, tableId = 9, name = "orbFitResidual",
	...
	INSERT INTO md_Column
	SET columnId = 173, tableId = 9, name = "orbFitChi2",
	...
	INSERT INTO md_Column
	SET columnId = 174, tableId = 9, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 175, tableId = 9, name = "ssmId",
	...
	INSERT INTO md_Column
	SET columnId = 176, tableId = 9, name = "mopsStatus",
	...
	INSERT INTO md_Column
	SET columnId = 177, tableId = 9, name = "stablePass",
	...
	INSERT INTO md_Column
	SET columnId = 178, tableId = 9, name = "timeCreated",
	...
	INSERT INTO md_Column
	SET columnId = 179, tableId = 9, name = "uMag",
	...
	INSERT INTO md_Column
	SET columnId = 180, tableId = 9, name = "uMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 181, tableId = 9, name = "uAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 182, tableId = 9, name = "uPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 183, tableId = 9, name = "gMag",
	...
	INSERT INTO md_Column
	SET columnId = 184, tableId = 9, name = "gMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 185, tableId = 9, name = "gAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 186, tableId = 9, name = "gPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 187, tableId = 9, name = "rMag",
	...
	INSERT INTO md_Column
	SET columnId = 188, tableId = 9, name = "rMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 189, tableId = 9, name = "rAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 190, tableId = 9, name = "rPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 191, tableId = 9, name = "iMag",
	...
	INSERT INTO md_Column
	SET columnId = 192, tableId = 9, name = "iMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 193, tableId = 9, name = "iAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 194, tableId = 9, name = "iPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 195, tableId = 9, name = "zMag",
	...
	INSERT INTO md_Column
	SET columnId = 196, tableId = 9, name = "zMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 197, tableId = 9, name = "zAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 198, tableId = 9, name = "zPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 199, tableId = 9, name = "yMag",
	...
	INSERT INTO md_Column
	SET columnId = 200, tableId = 9, name = "yMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 201, tableId = 9, name = "yAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 202, tableId = 9, name = "yPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 203, tableId = 9, name = "flag",
	...
	INSERT INTO md_Column
	SET columnId = 204, tableId = 9, name = "src01",
	...
	INSERT INTO md_Column
	SET columnId = 205, tableId = 9, name = "src02",
	...
	INSERT INTO md_Column
	SET columnId = 206, tableId = 9, name = "src03",
	...
	INSERT INTO md_Column
	SET columnId = 207, tableId = 9, name = "src04",
	...
	INSERT INTO md_Column
	SET columnId = 208, tableId = 9, name = "src05",
	...
	INSERT INTO md_Column
	SET columnId = 209, tableId = 9, name = "src06",
	...
	INSERT INTO md_Column
	SET columnId = 210, tableId = 9, name = "src07",
	...
	INSERT INTO md_Column
	SET columnId = 211, tableId = 9, name = "src08",
	...
	INSERT INTO md_Column
	SET columnId = 212, tableId = 9, name = "src09",
	...
	INSERT INTO md_Column
	SET columnId = 213, tableId = 9, name = "src10",
	...
	INSERT INTO md_Column
	SET columnId = 214, tableId = 9, name = "src11",
	...
	INSERT INTO md_Column
	SET columnId = 215, tableId = 9, name = "src12",
	...
	INSERT INTO md_Column
	SET columnId = 216, tableId = 9, name = "src13",
	...
	INSERT INTO md_Column
	SET columnId = 217, tableId = 9, name = "src14",
	...
	INSERT INTO md_Column
	SET columnId = 218, tableId = 9, name = "src15",
	...
	INSERT INTO md_Column
	SET columnId = 219, tableId = 9, name = "src16",
	...
	INSERT INTO md_Column
	SET columnId = 220, tableId = 9, name = "src17",
	...
	INSERT INTO md_Column
	SET columnId = 221, tableId = 9, name = "src18",
	...
	INSERT INTO md_Column
	SET columnId = 222, tableId = 9, name = "src19",
	...
	INSERT INTO md_Column
	SET columnId = 223, tableId = 9, name = "src20",
	...
	INSERT INTO md_Column
	SET columnId = 224, tableId = 9, name = "src21",
	...
	INSERT INTO md_Column
	SET columnId = 225, tableId = 9, name = "convCode",
	...
	INSERT INTO md_Column
	SET columnId = 226, tableId = 9, name = "o_minus_c",
	...
	INSERT INTO md_Column
	SET columnId = 227, tableId = 9, name = "moid1",
	...
	INSERT INTO md_Column
	SET columnId = 228, tableId = 9, name = "moidLong1",
	...
	INSERT INTO md_Column
	SET columnId = 229, tableId = 9, name = "moid2",
	...
	INSERT INTO md_Column
	SET columnId = 230, tableId = 9, name = "moidLong2",
	...
	INSERT INTO md_Column
	SET columnId = 231, tableId = 9, name = "arcLengthDays",
...
SET tableId = 10, name = "Object",
	...
	INSERT INTO md_Column
	SET columnId = 232, tableId = 10, name = "objectId",
		description = "Unique id.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 233, tableId = 10, name = "iauId",
	...
	INSERT INTO md_Column
	SET columnId = 234, tableId = 10, name = "ra_PS",
	...
	INSERT INTO md_Column
	SET columnId = 235, tableId = 10, name = "ra_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 236, tableId = 10, name = "decl_PS",
	...
	INSERT INTO md_Column
	SET columnId = 237, tableId = 10, name = "decl_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 238, tableId = 10, name = "radecl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 239, tableId = 10, name = "ra_SG",
	...
	INSERT INTO md_Column
	SET columnId = 240, tableId = 10, name = "ra_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 241, tableId = 10, name = "decl_SG",
	...
	INSERT INTO md_Column
	SET columnId = 242, tableId = 10, name = "decl_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 243, tableId = 10, name = "radecl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 244, tableId = 10, name = "raRange",
	...
	INSERT INTO md_Column
	SET columnId = 245, tableId = 10, name = "declRange",
	...
	INSERT INTO md_Column
	SET columnId = 246, tableId = 10, name = "muRa_PS",
	...
	INSERT INTO md_Column
	SET columnId = 247, tableId = 10, name = "muRa_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 248, tableId = 10, name = "muDecl_PS",
	...
	INSERT INTO md_Column
	SET columnId = 249, tableId = 10, name = "muDecl_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 250, tableId = 10, name = "muRaDecl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 251, tableId = 10, name = "parallax_PS",
	...
	INSERT INTO md_Column
	SET columnId = 252, tableId = 10, name = "parallax_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 253, tableId = 10, name = "canonicalFilterId",
	...
	INSERT INTO md_Column
	SET columnId = 254, tableId = 10, name = "extendedness",
	...
	INSERT INTO md_Column
	SET columnId = 255, tableId = 10, name = "varProb",
	...
	INSERT INTO md_Column
	SET columnId = 256, tableId = 10, name = "earliestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 257, tableId = 10, name = "latestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 258, tableId = 10, name = "flags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 27;

	INSERT INTO md_Column
	SET columnId = 259, tableId = 10, name = "uNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 260, tableId = 10, name = "uExtendedness",
	...
	INSERT INTO md_Column
	SET columnId = 261, tableId = 10, name = "uVarProb",
	...
	INSERT INTO md_Column
	SET columnId = 262, tableId = 10, name = "uRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 263, tableId = 10, name = "uRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 264, tableId = 10, name = "uDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 265, tableId = 10, name = "uDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 266, tableId = 10, name = "uRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 267, tableId = 10, name = "uRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 268, tableId = 10, name = "uRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 269, tableId = 10, name = "uDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 270, tableId = 10, name = "uDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 271, tableId = 10, name = "uRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 272, tableId = 10, name = "uLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 273, tableId = 10, name = "uLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 274, tableId = 10, name = "uFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 275, tableId = 10, name = "uFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 276, tableId = 10, name = "uFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 277, tableId = 10, name = "uFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 278, tableId = 10, name = "uFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 279, tableId = 10, name = "uFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 280, tableId = 10, name = "uTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 281, tableId = 10, name = "uEarliestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 282, tableId = 10, name = "uLatestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 283, tableId = 10, name = "uSersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 284, tableId = 10, name = "uSersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 285, tableId = 10, name = "uE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 286, tableId = 10, name = "uE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 287, tableId = 10, name = "uE2_SG",
		description = "Ellipticity for Small Galaxy model for u filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 56;
	...
	INSERT INTO md_Column
	SET columnId = 288, tableId = 10, name = "uE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 289, tableId = 10, name = "uRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 290, tableId = 10, name = "uRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 291, tableId = 10, name = "uFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 60;

	INSERT INTO md_Column
	SET columnId = 292, tableId = 10, name = "gNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 293, tableId = 10, name = "gExtendedness",
	...
	INSERT INTO md_Column
	SET columnId = 294, tableId = 10, name = "gVarProb",
	...
	INSERT INTO md_Column
	SET columnId = 295, tableId = 10, name = "gRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 296, tableId = 10, name = "gRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 297, tableId = 10, name = "gDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 298, tableId = 10, name = "gDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 299, tableId = 10, name = "gRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 300, tableId = 10, name = "gRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 301, tableId = 10, name = "gRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 302, tableId = 10, name = "gDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 303, tableId = 10, name = "gDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 304, tableId = 10, name = "gRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 305, tableId = 10, name = "gLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 306, tableId = 10, name = "gLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 307, tableId = 10, name = "gFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 308, tableId = 10, name = "gFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 309, tableId = 10, name = "gFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 310, tableId = 10, name = "gFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 311, tableId = 10, name = "gFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 312, tableId = 10, name = "gFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 313, tableId = 10, name = "gTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 314, tableId = 10, name = "gEarliestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 315, tableId = 10, name = "gLatestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 316, tableId = 10, name = "gSersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 317, tableId = 10, name = "gSersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 318, tableId = 10, name = "gE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 319, tableId = 10, name = "gE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 320, tableId = 10, name = "gE2_SG",
		description = "Ellipticity for Small Galaxy model for g filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 89;
	...
	INSERT INTO md_Column
	SET columnId = 321, tableId = 10, name = "gE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 322, tableId = 10, name = "gRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 323, tableId = 10, name = "gRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 324, tableId = 10, name = "gFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 93;

	INSERT INTO md_Column
	SET columnId = 325, tableId = 10, name = "rNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 326, tableId = 10, name = "rExtendedness",
	...
	INSERT INTO md_Column
	SET columnId = 327, tableId = 10, name = "rVarProb",
	...
	INSERT INTO md_Column
	SET columnId = 328, tableId = 10, name = "rRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 329, tableId = 10, name = "rRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 330, tableId = 10, name = "rDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 331, tableId = 10, name = "rDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 332, tableId = 10, name = "rRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 333, tableId = 10, name = "rRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 334, tableId = 10, name = "rRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 335, tableId = 10, name = "rDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 336, tableId = 10, name = "rDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 337, tableId = 10, name = "rRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 338, tableId = 10, name = "rLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 339, tableId = 10, name = "rLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 340, tableId = 10, name = "rFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 341, tableId = 10, name = "rFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 342, tableId = 10, name = "rFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 343, tableId = 10, name = "rFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 344, tableId = 10, name = "rFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 345, tableId = 10, name = "rFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 346, tableId = 10, name = "rTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 347, tableId = 10, name = "rEarliestObsTime",
		description = "Time when this object was observed for the first time in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 116;
	...
	INSERT INTO md_Column
	SET columnId = 348, tableId = 10, name = "rLatestObsTime",
		description = "The latest time when this object was observed in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 117;
	...
	INSERT INTO md_Column
	SET columnId = 349, tableId = 10, name = "rSersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 350, tableId = 10, name = "rSersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 351, tableId = 10, name = "rE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 352, tableId = 10, name = "rE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 353, tableId = 10, name = "rE2_SG",
		description = "Ellipticity for Small Galaxy model for r filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 122;
	...
	INSERT INTO md_Column
	SET columnId = 354, tableId = 10, name = "rE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 355, tableId = 10, name = "rRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 356, tableId = 10, name = "rRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 357, tableId = 10, name = "rFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 126;

	INSERT INTO md_Column
	SET columnId = 358, tableId = 10, name = "iNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 359, tableId = 10, name = "iExtendedness",
	...
	INSERT INTO md_Column
	SET columnId = 360, tableId = 10, name = "iVarProb",
	...
	INSERT INTO md_Column
	SET columnId = 361, tableId = 10, name = "iRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 362, tableId = 10, name = "iRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 363, tableId = 10, name = "iDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 364, tableId = 10, name = "iDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 365, tableId = 10, name = "iRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 366, tableId = 10, name = "iRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 367, tableId = 10, name = "iRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 368, tableId = 10, name = "iDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 369, tableId = 10, name = "iDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 370, tableId = 10, name = "iRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 371, tableId = 10, name = "iLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 372, tableId = 10, name = "iLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 373, tableId = 10, name = "iFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 374, tableId = 10, name = "iFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 375, tableId = 10, name = "iFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 376, tableId = 10, name = "iFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 377, tableId = 10, name = "iFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 378, tableId = 10, name = "iFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 379, tableId = 10, name = "iTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 380, tableId = 10, name = "iEarliestObsTime",
		description = "Time when this object was observed for the first time in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 149;
	...
	INSERT INTO md_Column
	SET columnId = 381, tableId = 10, name = "iLatestObsTime",
		description = "The latest time when this object was observed in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 150;
	...
	INSERT INTO md_Column
	SET columnId = 382, tableId = 10, name = "iSersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 383, tableId = 10, name = "iSersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 384, tableId = 10, name = "iE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 385, tableId = 10, name = "iE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 386, tableId = 10, name = "iE2_SG",
		description = "Ellipticity for Small Galaxy model for i filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 155;
	...
	INSERT INTO md_Column
	SET columnId = 387, tableId = 10, name = "iE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 388, tableId = 10, name = "iRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 389, tableId = 10, name = "iRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 390, tableId = 10, name = "iFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 159;

	INSERT INTO md_Column
	SET columnId = 391, tableId = 10, name = "zNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 392, tableId = 10, name = "zExtendedness",
	...
	INSERT INTO md_Column
	SET columnId = 393, tableId = 10, name = "zVarProb",
	...
	INSERT INTO md_Column
	SET columnId = 394, tableId = 10, name = "zRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 395, tableId = 10, name = "zRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 396, tableId = 10, name = "zDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 397, tableId = 10, name = "zDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 398, tableId = 10, name = "zRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 399, tableId = 10, name = "zRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 400, tableId = 10, name = "zRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 401, tableId = 10, name = "zDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 402, tableId = 10, name = "zDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 403, tableId = 10, name = "zRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 404, tableId = 10, name = "zLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 405, tableId = 10, name = "zLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 406, tableId = 10, name = "zFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 407, tableId = 10, name = "zFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 408, tableId = 10, name = "zFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 409, tableId = 10, name = "zFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 410, tableId = 10, name = "zFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 411, tableId = 10, name = "zFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 412, tableId = 10, name = "zTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 413, tableId = 10, name = "zEarliestObsTime",
		description = "Time when this object was observed for the first time in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 182;
	...
	INSERT INTO md_Column
	SET columnId = 414, tableId = 10, name = "zLatestObsTime",
		description = "The latest time when this object was observed in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 183;
	...
	INSERT INTO md_Column
	SET columnId = 415, tableId = 10, name = "zSersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 416, tableId = 10, name = "zSersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 417, tableId = 10, name = "zE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 418, tableId = 10, name = "zE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 419, tableId = 10, name = "zE2_SG",
		description = "Ellipticity for Small Galaxy model for z filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 188;
	...
	INSERT INTO md_Column
	SET columnId = 420, tableId = 10, name = "zE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 421, tableId = 10, name = "zRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 422, tableId = 10, name = "zRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 423, tableId = 10, name = "zFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 192;

	INSERT INTO md_Column
	SET columnId = 424, tableId = 10, name = "yNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 425, tableId = 10, name = "yExtendedness",
	...
	INSERT INTO md_Column
	SET columnId = 426, tableId = 10, name = "yVarProb",
	...
	INSERT INTO md_Column
	SET columnId = 427, tableId = 10, name = "yRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 428, tableId = 10, name = "yRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 429, tableId = 10, name = "yDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 430, tableId = 10, name = "yDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 431, tableId = 10, name = "yRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 432, tableId = 10, name = "yRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 433, tableId = 10, name = "yRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 434, tableId = 10, name = "yDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 435, tableId = 10, name = "yDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 436, tableId = 10, name = "yRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 437, tableId = 10, name = "yLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 438, tableId = 10, name = "yLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 439, tableId = 10, name = "yFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 440, tableId = 10, name = "yFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 441, tableId = 10, name = "yFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 442, tableId = 10, name = "yFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 443, tableId = 10, name = "yFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 444, tableId = 10, name = "yFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 445, tableId = 10, name = "yTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 446, tableId = 10, name = "yEarliestObsTime",
		description = "Time when this object was observed for the first time in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 215;
	...
	INSERT INTO md_Column
	SET columnId = 447, tableId = 10, name = "yLatestObsTime",
		description = "The latest time when this object was observed in g filter.&#xA;",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 216;
	...
	INSERT INTO md_Column
	SET columnId = 448, tableId = 10, name = "ySersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 449, tableId = 10, name = "ySersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 450, tableId = 10, name = "yE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 451, tableId = 10, name = "yE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 452, tableId = 10, name = "yE2_SG",
		description = "Ellipticity for Small Galaxy model for y filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 221;
	...
	INSERT INTO md_Column
	SET columnId = 453, tableId = 10, name = "yE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 454, tableId = 10, name = "yRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 455, tableId = 10, name = "yRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 456, tableId = 10, name = "yFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 225;

	INSERT INTO md_Column
	SET columnId = 457, tableId = 10, name = "_chunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 226;
	...
	INSERT INTO md_Column
	SET columnId = 458, tableId = 10, name = "_subChunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 227;
...
SET tableId = 11, name = "ObjectExtras",
	...
	INSERT INTO md_Column
	SET columnId = 459, tableId = 11, name = "objectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 460, tableId = 11, name = "uFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 461, tableId = 11, name = "uFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 462, tableId = 11, name = "uRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 463, tableId = 11, name = "uFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 464, tableId = 11, name = "uFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 465, tableId = 11, name = "uFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 466, tableId = 11, name = "uFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 467, tableId = 11, name = "uFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 468, tableId = 11, name = "uFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 469, tableId = 11, name = "uRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 470, tableId = 11, name = "uRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 471, tableId = 11, name = "uRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 472, tableId = 11, name = "uRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 473, tableId = 11, name = "uRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 474, tableId = 11, name = "uDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 475, tableId = 11, name = "uDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 476, tableId = 11, name = "uDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 477, tableId = 11, name = "uDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 478, tableId = 11, name = "uSersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 479, tableId = 11, name = "uSersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 480, tableId = 11, name = "uSersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 481, tableId = 11, name = "uE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 482, tableId = 11, name = "uE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 483, tableId = 11, name = "uE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 484, tableId = 11, name = "gFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 485, tableId = 11, name = "gFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 486, tableId = 11, name = "gRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 487, tableId = 11, name = "gFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 488, tableId = 11, name = "gFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 489, tableId = 11, name = "gFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 490, tableId = 11, name = "gFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 491, tableId = 11, name = "gFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 492, tableId = 11, name = "gFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 493, tableId = 11, name = "gRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 494, tableId = 11, name = "gRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 495, tableId = 11, name = "gRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 496, tableId = 11, name = "gRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 497, tableId = 11, name = "gRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 498, tableId = 11, name = "gDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 499, tableId = 11, name = "gDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 500, tableId = 11, name = "gDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 501, tableId = 11, name = "gDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 502, tableId = 11, name = "gSersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 503, tableId = 11, name = "gSersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 504, tableId = 11, name = "gSersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 505, tableId = 11, name = "gE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 506, tableId = 11, name = "gE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 507, tableId = 11, name = "gE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 508, tableId = 11, name = "rFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 509, tableId = 11, name = "rFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 510, tableId = 11, name = "rRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 511, tableId = 11, name = "rFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 512, tableId = 11, name = "rFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 513, tableId = 11, name = "rFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 514, tableId = 11, name = "rFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 515, tableId = 11, name = "rFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 516, tableId = 11, name = "rFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 517, tableId = 11, name = "rRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 518, tableId = 11, name = "rRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 519, tableId = 11, name = "rRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 520, tableId = 11, name = "rRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 521, tableId = 11, name = "rRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 522, tableId = 11, name = "rDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 523, tableId = 11, name = "rDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 524, tableId = 11, name = "rDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 525, tableId = 11, name = "rDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 526, tableId = 11, name = "rSersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 527, tableId = 11, name = "rSersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 528, tableId = 11, name = "rSersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 529, tableId = 11, name = "rE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 530, tableId = 11, name = "rE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 531, tableId = 11, name = "rE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 532, tableId = 11, name = "iFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 533, tableId = 11, name = "iFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 534, tableId = 11, name = "iRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 535, tableId = 11, name = "iFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 536, tableId = 11, name = "iFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 537, tableId = 11, name = "iFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 538, tableId = 11, name = "iFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 539, tableId = 11, name = "iFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 540, tableId = 11, name = "iFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 541, tableId = 11, name = "iRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 542, tableId = 11, name = "iRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 543, tableId = 11, name = "iRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 544, tableId = 11, name = "iRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 545, tableId = 11, name = "iRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 546, tableId = 11, name = "iDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 547, tableId = 11, name = "iDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 548, tableId = 11, name = "iDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 549, tableId = 11, name = "iDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 550, tableId = 11, name = "iSersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 551, tableId = 11, name = "iSersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 552, tableId = 11, name = "iSersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 553, tableId = 11, name = "iE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 554, tableId = 11, name = "iE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 555, tableId = 11, name = "iE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 556, tableId = 11, name = "zFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 557, tableId = 11, name = "zFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 558, tableId = 11, name = "zRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 559, tableId = 11, name = "zFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 560, tableId = 11, name = "zFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 561, tableId = 11, name = "zFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 562, tableId = 11, name = "zFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 563, tableId = 11, name = "zFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 564, tableId = 11, name = "zFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 565, tableId = 11, name = "zRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 566, tableId = 11, name = "zRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 567, tableId = 11, name = "zRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 568, tableId = 11, name = "zRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 569, tableId = 11, name = "zRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 570, tableId = 11, name = "zDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 571, tableId = 11, name = "zDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 572, tableId = 11, name = "zDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 573, tableId = 11, name = "zDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 574, tableId = 11, name = "zSersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 575, tableId = 11, name = "zSersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 576, tableId = 11, name = "zSersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 577, tableId = 11, name = "zE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 578, tableId = 11, name = "zE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 579, tableId = 11, name = "zE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 580, tableId = 11, name = "yFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 581, tableId = 11, name = "yFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 582, tableId = 11, name = "yRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 583, tableId = 11, name = "yFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 584, tableId = 11, name = "yFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 585, tableId = 11, name = "yFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 586, tableId = 11, name = "yFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 587, tableId = 11, name = "yFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 588, tableId = 11, name = "yFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 589, tableId = 11, name = "yRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 590, tableId = 11, name = "yRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 591, tableId = 11, name = "yRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 592, tableId = 11, name = "yRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 593, tableId = 11, name = "yRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 594, tableId = 11, name = "yDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 595, tableId = 11, name = "yDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 596, tableId = 11, name = "yDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 597, tableId = 11, name = "yDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 598, tableId = 11, name = "ySersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 599, tableId = 11, name = "ySersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 600, tableId = 11, name = "ySersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 601, tableId = 11, name = "yE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 602, tableId = 11, name = "yE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 603, tableId = 11, name = "yE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 604, tableId = 11, name = "_chunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 146;
	...
	INSERT INTO md_Column
	SET columnId = 605, tableId = 11, name = "_subChunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 147;
...
SET tableId = 12, name = "ObjectType",
	...
	INSERT INTO md_Column
	SET columnId = 606, tableId = 12, name = "typeId",
		description = "Unique id.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 607, tableId = 12, name = "description",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 2;
...
SET tableId = 13, name = "RaftMetadata";
	...
	INSERT INTO md_Column
	SET columnId = 608, tableId = 13, name = "raftId",
		description = "tbd&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 609, tableId = 13, name = "metadataKey",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 610, tableId = 13, name = "metadataValue",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 3;
...
SET tableId = 14, name = "Raw_Amp_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 611, tableId = 14, name = "rawAmpExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 612, tableId = 14, name = "rawCcdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 613, tableId = 14, name = "ampId",
...
SET tableId = 15, name = "Raw_Amp_Exposure_Metadata",
	...
	INSERT INTO md_Column
	SET columnId = 615, tableId = 15, name = "exposureType",
	...
	INSERT INTO md_Column
	SET columnId = 616, tableId = 15, name = "metadataKey",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 617, tableId = 15, name = "metadataValue",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 16, name = "Raw_Amp_To_Science_Ccd_Exposure";

	INSERT INTO md_Column
	SET columnId = 618, tableId = 16, name = "rawAmpExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 619, tableId = 16, name = "scienceCcdExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 620, tableId = 16, name = "snap",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 621, tableId = 16, name = "amp",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 17, name = "Raw_Amp_To_Snap_Ccd_Exposure";

	INSERT INTO md_Column
	SET columnId = 622, tableId = 17, name = "rawAmpExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 623, tableId = 17, name = "amp",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 624, tableId = 17, name = "snapCcdExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
...
INSERT INTO md_Table
SET tableId = 18, name = "Raw_Ccd_Exposure";

	INSERT INTO md_Column
	SET columnId = 625, tableId = 18, name = "rawCcdExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 626, tableId = 18, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 627, tableId = 18, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 628, tableId = 18, name = "filterId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 629, tableId = 18, name = "equinox",
	...
	INSERT INTO md_Column
	SET columnId = 630, tableId = 18, name = "radecSys",
	...
	INSERT INTO md_Column
	SET columnId = 631, tableId = 18, name = "dateObs",
	...
	INSERT INTO md_Column
	SET columnId = 632, tableId = 18, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 633, tableId = 18, name = "ctype1",
	...
	INSERT INTO md_Column
	SET columnId = 634, tableId = 18, name = "ctype2",
	...
	INSERT INTO md_Column
	SET columnId = 635, tableId = 18, name = "mjdObs",
	...
	INSERT INTO md_Column
	SET columnId = 636, tableId = 18, name = "airmass",
	...
	INSERT INTO md_Column
	SET columnId = 637, tableId = 18, name = "crpix1",
	...
	INSERT INTO md_Column
	SET columnId = 638, tableId = 18, name = "crpix2",
	...
	INSERT INTO md_Column
	SET columnId = 639, tableId = 18, name = "crval1",
	...
	INSERT INTO md_Column
	SET columnId = 640, tableId = 18, name = "crval2",
	...
	INSERT INTO md_Column
	SET columnId = 641, tableId = 18, name = "cd11",
	...
	INSERT INTO md_Column
	SET columnId = 642, tableId = 18, name = "cd21",
	...
	INSERT INTO md_Column
	SET columnId = 643, tableId = 18, name = "darkTime",
	...
	INSERT INTO md_Column
	SET columnId = 644, tableId = 18, name = "cd12",
	...
	INSERT INTO md_Column
	SET columnId = 645, tableId = 18, name = "zd",
	...
	INSERT INTO md_Column
	SET columnId = 646, tableId = 18, name = "cd22",
	...
	INSERT INTO md_Column
	SET columnId = 647, tableId = 18, name = "taiObs",
	...
	INSERT INTO md_Column
	SET columnId = 648, tableId = 18, name = "expTime",
...
INSERT INTO md_Table
SET tableId = 19, name = "Raw_Ccd_Exposure_Metadata",
	description = "Generic key-value pair metadata for Raw_Ccd_Exposure.&#xA;";

	INSERT INTO md_Column
	SET columnId = 649, tableId = 19, name = "rawCcdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 650, tableId = 19, name = "exposureType",
	...
	INSERT INTO md_Column
	SET columnId = 651, tableId = 19, name = "metadataKey",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 652, tableId = 19, name = "metadataValue",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 20, name = "Science_Amp_Exposure";

	INSERT INTO md_Column
	SET columnId = 653, tableId = 20, name = "scienceAmpExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 654, tableId = 20, name = "scienceCcdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 655, tableId = 20, name = "rawAmpExposureId",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 656, tableId = 20, name = "ampId",
...
INSERT INTO md_Table
SET tableId = 21, name = "Science_Amp_Exposure_Metadata",
	description = "Generic key-value pair metadata for Science_Amp_Exposure.&#xA;";

	INSERT INTO md_Column
	SET columnId = 657, tableId = 21, name = "scienceAmpExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 658, tableId = 21, name = "exposureType",
	...
	INSERT INTO md_Column
	SET columnId = 659, tableId = 21, name = "metadataKey",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 660, tableId = 21, name = "metadataValue",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 22, name = "Science_Ccd_Exposure";

	INSERT INTO md_Column
	SET columnId = 661, tableId = 22, name = "scienceCcdExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 662, tableId = 22, name = "rawCcdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 663, tableId = 22, name = "snapId",
	...
	INSERT INTO md_Column
	SET columnId = 664, tableId = 22, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 665, tableId = 22, name = "equinox",
		description = "Equinox of World Coordinate System.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 666, tableId = 22, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 667, tableId = 22, name = "ctype1",
		description = "Coordinate projection type, axis 1.",
		type = "VARCHAR(20)",
		notNull = 0,
		displayOrder = 7;
	...
	INSERT INTO md_Column
	SET columnId = 668, tableId = 22, name = "ctype2",
		description = "Coordinate projection type, axis 2.",
		type = "VARCHAR(20)",
		notNull = 0,
		displayOrder = 8;
	...
	INSERT INTO md_Column
	SET columnId = 669, tableId = 22, name = "crpix1",
		description = "Coordinate reference pixel, axis 1.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 670, tableId = 22, name = "crpix2",
		description = "Coordinate reference pixel, axis 2.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 671, tableId = 22, name = "crval1",
		description = "Coordinate value 1 @reference pixel.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 672, tableId = 22, name = "crval2",
		description = "Coordinate value 2 @reference pixel.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 12;
	...
	INSERT INTO md_Column
	SET columnId = 673, tableId = 22, name = "cd1_1",
		description = "First derivative of coordinate 1 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 674, tableId = 22, name = "cd2_1",
		description = "First derivative of coordinate 2 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 675, tableId = 22, name = "cd1_2",
		description = "First derivative of coordinate 1 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 676, tableId = 22, name = "cd2_2",
		description = "First derivative of coordinate 2 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 16;
	...
	INSERT INTO md_Column
	SET columnId = 677, tableId = 22, name = "taiMjd",
	...
	INSERT INTO md_Column
	SET columnId = 678, tableId = 22, name = "ccdSize",
	...
	INSERT INTO md_Column
	SET columnId = 679, tableId = 22, name = "dateObs",
		description = "Date/Time of observation start (UTC).",
		type = "TIMESTAMP",
		notNull = 0,
		defaultValue = "0",
	...
	INSERT INTO md_Column
	SET columnId = 680, tableId = 22, name = "expTime",
		description = "Duration of exposure.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 20;
	...
	INSERT INTO md_Column
	SET columnId = 681, tableId = 22, name = "photoFlam",
	...
	INSERT INTO md_Column
	SET columnId = 682, tableId = 22, name = "photoZP",
	...
	INSERT INTO md_Column
	SET columnId = 683, tableId = 22, name = "nCombine",
	...
	INSERT INTO md_Column
	SET columnId = 684, tableId = 22, name = "binX",
	...
	INSERT INTO md_Column
	SET columnId = 685, tableId = 22, name = "binY",
	...
	INSERT INTO md_Column
	SET columnId = 686, tableId = 22, name = "readNoise",
	...
	INSERT INTO md_Column
	SET columnId = 687, tableId = 22, name = "saturationLimit",
	...
	INSERT INTO md_Column
	SET columnId = 688, tableId = 22, name = "dataSection",
	...
	INSERT INTO md_Column
	SET columnId = 689, tableId = 22, name = "gain",
...
INSERT INTO md_Table
SET tableId = 23, name = "Science_Ccd_Exposure_Metadata",
	description = "Generic key-value pair metadata for Science_Ccd_Exposure.&#xA;";

	INSERT INTO md_Column
	SET columnId = 690, tableId = 23, name = "scienceCcdExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 691, tableId = 23, name = "exposureType",
	...
	INSERT INTO md_Column
	SET columnId = 692, tableId = 23, name = "metadataKey",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 693, tableId = 23, name = "metadataValue",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 24, name = "Snap_Ccd_To_Science_Ccd_Exposure";

	INSERT INTO md_Column
	SET columnId = 694, tableId = 24, name = "snapCcdExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 695, tableId = 24, name = "snap",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 696, tableId = 24, name = "scienceCcdExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
...
INSERT INTO md_Table
SET tableId = 25, name = "Source_pt1",
	engine = "MyISAM";

	INSERT INTO md_Column
	SET columnId = 697, tableId = 25, name = "sourceId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 698, tableId = 25, name = "ampExposureId",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 699, tableId = 25, name = "filterId",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 700, tableId = 25, name = "objectId",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 701, tableId = 25, name = "movingObjectId",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 702, tableId = 25, name = "procHistoryId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 703, tableId = 25, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 704, tableId = 25, name = "raErrForDetection",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 705, tableId = 25, name = "raErrForWcs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 706, tableId = 25, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 10;

	INSERT INTO md_Column
	SET columnId = 707, tableId = 25, name = "declErrForDetection",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 11;

	INSERT INTO md_Column
	SET columnId = 708, tableId = 25, name = "declErrForWcs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 12;

	INSERT INTO md_Column
	SET columnId = 709, tableId = 25, name = "xFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 13;

	INSERT INTO md_Column
	SET columnId = 710, tableId = 25, name = "xFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 14;

	INSERT INTO md_Column
	SET columnId = 711, tableId = 25, name = "yFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 15;

	INSERT INTO md_Column
	SET columnId = 712, tableId = 25, name = "yFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 16;

	INSERT INTO md_Column
	SET columnId = 713, tableId = 25, name = "raFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 17;

	INSERT INTO md_Column
	SET columnId = 714, tableId = 25, name = "raFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 18;

	INSERT INTO md_Column
	SET columnId = 715, tableId = 25, name = "declFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 19;

	INSERT INTO md_Column
	SET columnId = 716, tableId = 25, name = "declFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 20;

	INSERT INTO md_Column
	SET columnId = 717, tableId = 25, name = "xPeak",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 21;

	INSERT INTO md_Column
	SET columnId = 718, tableId = 25, name = "yPeak",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 22;

	INSERT INTO md_Column
	SET columnId = 719, tableId = 25, name = "raPeak",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 23;

	INSERT INTO md_Column
	SET columnId = 720, tableId = 25, name = "declPeak",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 24;

	INSERT INTO md_Column
	SET columnId = 721, tableId = 25, name = "xAstrom",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 25;

	INSERT INTO md_Column
	SET columnId = 722, tableId = 25, name = "xAstromErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 26;

	INSERT INTO md_Column
	SET columnId = 723, tableId = 25, name = "yAstrom",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 27;

	INSERT INTO md_Column
	SET columnId = 724, tableId = 25, name = "yAstromErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;

	INSERT INTO md_Column
	SET columnId = 725, tableId = 25, name = "raAstrom",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 29;

	INSERT INTO md_Column
	SET columnId = 726, tableId = 25, name = "raAstromErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 30;

	INSERT INTO md_Column
	SET columnId = 727, tableId = 25, name = "declAstrom",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 31;

	INSERT INTO md_Column
	SET columnId = 728, tableId = 25, name = "declAstromErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 32;

	INSERT INTO md_Column
	SET columnId = 729, tableId = 25, name = "raObject",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 33;

	INSERT INTO md_Column
	SET columnId = 730, tableId = 25, name = "declObject",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 34;

	INSERT INTO md_Column
	SET columnId = 731, tableId = 25, name = "taiMidPoint",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 35;

	INSERT INTO md_Column
	SET columnId = 732, tableId = 25, name = "taiRange",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 36;

	INSERT INTO md_Column
	SET columnId = 733, tableId = 25, name = "psfFlux",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 37;

	INSERT INTO md_Column
	SET columnId = 734, tableId = 25, name = "psfFluxErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 38;

	INSERT INTO md_Column
	SET columnId = 735, tableId = 25, name = "apFlux",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 39;

	INSERT INTO md_Column
	SET columnId = 736, tableId = 25, name = "apFluxErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 40;

	INSERT INTO md_Column
	SET columnId = 737, tableId = 25, name = "modelFlux",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 41;

	INSERT INTO md_Column
	SET columnId = 738, tableId = 25, name = "modelFluxErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 42;

	INSERT INTO md_Column
	SET columnId = 739, tableId = 25, name = "petroFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 43;

	INSERT INTO md_Column
	SET columnId = 740, tableId = 25, name = "petroFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 44;

	INSERT INTO md_Column
	SET columnId = 741, tableId = 25, name = "instFlux",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 45;

	INSERT INTO md_Column
	SET columnId = 742, tableId = 25, name = "instFluxErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 46;

	INSERT INTO md_Column
	SET columnId = 743, tableId = 25, name = "nonGrayCorrFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 47;

	INSERT INTO md_Column
	SET columnId = 744, tableId = 25, name = "nonGrayCorrFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 48;

	INSERT INTO md_Column
	SET columnId = 745, tableId = 25, name = "atmCorrFlux",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 49;

	INSERT INTO md_Column
	SET columnId = 746, tableId = 25, name = "atmCorrFluxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 50;

	INSERT INTO md_Column
	SET columnId = 747, tableId = 25, name = "apDia",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 51;

	INSERT INTO md_Column
	SET columnId = 748, tableId = 25, name = "Ixx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 52;

	INSERT INTO md_Column
	SET columnId = 749, tableId = 25, name = "IxxErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 53;

	INSERT INTO md_Column
	SET columnId = 750, tableId = 25, name = "Iyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 54;

	INSERT INTO md_Column
	SET columnId = 751, tableId = 25, name = "IyyErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 55;

	INSERT INTO md_Column
	SET columnId = 752, tableId = 25, name = "Ixy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 56;

	INSERT INTO md_Column
	SET columnId = 753, tableId = 25, name = "IxyErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 57;

	INSERT INTO md_Column
	SET columnId = 754, tableId = 25, name = "snr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 58;

	INSERT INTO md_Column
	SET columnId = 755, tableId = 25, name = "chi2",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 59;

	INSERT INTO md_Column
	SET columnId = 756, tableId = 25, name = "sky",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 60;

	INSERT INTO md_Column
	SET columnId = 757, tableId = 25, name = "skyErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 61;

	INSERT INTO md_Column
	SET columnId = 758, tableId = 25, name = "extendedness",
	...
	INSERT INTO md_Column
	SET columnId = 759, tableId = 25, name = "flux_PS",
		description = "Calibrated flux for Point Source model.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 63;
	...
	INSERT INTO md_Column
	SET columnId = 760, tableId = 25, name = "flux_PS_Sigma",
		description = "Uncertainty of flux_PS.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 64;
	...
	INSERT INTO md_Column
	SET columnId = 761, tableId = 25, name = "flux_SG",
		description = "Calibrated flux for Small Galaxy model.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 65;
	...
	INSERT INTO md_Column
	SET columnId = 762, tableId = 25, name = "flux_SG_Sigma",
		description = "Uncertainty of flux_SG.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 66;
	...
	INSERT INTO md_Column
	SET columnId = 763, tableId = 25, name = "sersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 764, tableId = 25, name = "sersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 765, tableId = 25, name = "e1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 766, tableId = 25, name = "e1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 767, tableId = 25, name = "e2_SG",
		description = "Ellipticity for Small Galaxy model.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 71;
	...
	INSERT INTO md_Column
	SET columnId = 768, tableId = 25, name = "e2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 769, tableId = 25, name = "radius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 770, tableId = 25, name = "radius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 771, tableId = 25, name = "flux_flux_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 772, tableId = 25, name = "flux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 773, tableId = 25, name = "flux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 774, tableId = 25, name = "flux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 775, tableId = 25, name = "flux_sersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 776, tableId = 25, name = "e1_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 777, tableId = 25, name = "e1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 778, tableId = 25, name = "e1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 779, tableId = 25, name = "e1_sersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 780, tableId = 25, name = "e2_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 781, tableId = 25, name = "e2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 782, tableId = 25, name = "e2_sersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 783, tableId = 25, name = "radius_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 784, tableId = 25, name = "radius_sersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 785, tableId = 25, name = "sersicN_sersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 786, tableId = 25, name = "flagForAssociation",
		type = "SMALLINT",
		notNull = 0,
		displayOrder = 90;

	INSERT INTO md_Column
	SET columnId = 787, tableId = 25, name = "flagForDetection",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 91;

	INSERT INTO md_Column
	SET columnId = 788, tableId = 25, name = "flagForWcs",
		type = "SMALLINT",
		notNull = 0,
		displayOrder = 92;
...
INSERT INTO md_Table
SET tableId = 26, name = "Source_pt2",
	engine = "MyISAM",
	...
	INSERT INTO md_Column
	SET columnId = 789, tableId = 26, name = "sourceId",
		description = "Unique id.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 790, tableId = 26, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 791, tableId = 26, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 792, tableId = 26, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 793, tableId = 26, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 794, tableId = 26, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 795, tableId = 26, name = "raSigma",
		description = "Uncertainty of ra.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 796, tableId = 26, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 797, tableId = 26, name = "declSigma",
		description = "Uncertainty of decl.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 798, tableId = 26, name = "xAstrom",
		description = "x position computed by a centroiding algorithm for the purposes of astrometry using Dave Monet's algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 799, tableId = 26, name = "xAstromSigma",
		description = "Uncertainty of xAstrom.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 800, tableId = 26, name = "yAstrom",
		description = "y position computed by a centroiding algorithm for the purposes of astrometry using Dave Monet's algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 801, tableId = 26, name = "yAstromSigma",
		description = "Uncertainty of yAstrom.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 802, tableId = 26, name = "xyAstromCov",
		description = "Covariance between the xAstrom and the yAstrom.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 803, tableId = 26, name = "xOther",
		description = "x position computed by a centroiding algorithm for the purposes of astrometry using &quot;other&quot; centroiding algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 804, tableId = 26, name = "xOtherSigma",
		description = "Uncertainty of xOther.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 805, tableId = 26, name = "yOther",
		description = "y position computed by a centroiding algorithm for the purposes of astrometry using &quot;other&quot; centroiding algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 806, tableId = 26, name = "yOtherSigma",
		description = "Uncertainty of yOther.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 807, tableId = 26, name = "xyOtherCov",
		description = "Covariance between the xOther and yOther.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 19;
	...
	INSERT INTO md_Column
	SET columnId = 808, tableId = 26, name = "astromRefrRa",
		description = "Astrometric refraction in ra.&#xA;",
		type = "FLOAT",
		notNull = 0,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 809, tableId = 26, name = "astromRefrRaSigma",
		description = "Uncertainty of astromRefrRa.&#xA;",
		type = "FLOAT",
		notNull = 0,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 810, tableId = 26, name = "astromRefrDecl",
		description = "Astrometric refraction in decl.&#xA;",
		type = "FLOAT",
		notNull = 0,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 811, tableId = 26, name = "astromRefrDeclSigma",
		description = "Uncertainty of astromRefrDecl.&#xA;",
		type = "FLOAT",
		notNull = 0,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 812, tableId = 26, name = "sky",
		description = "Sky background.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 24;
	...
	INSERT INTO md_Column
	SET columnId = 813, tableId = 26, name = "skySigma",
		description = "Uncertainty of sky.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 25;
	...
	INSERT INTO md_Column
	SET columnId = 814, tableId = 26, name = "psfLnL",
		description = "ln(likelihood) of being a PSF.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 26;
	...
	INSERT INTO md_Column
	SET columnId = 815, tableId = 26, name = "lnL_SG",
		description = "Log-likelihood of being a Small Galaxy.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 27;
	...
	INSERT INTO md_Column
	SET columnId = 816, tableId = 26, name = "flux_PS",
		description = "Calibrated flux for Point Source model.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;
	...
	INSERT INTO md_Column
	SET columnId = 817, tableId = 26, name = "flux_PS_Sigma",
		description = "Uncertainty of flux_PS.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 29;
	...
	INSERT INTO md_Column
	SET columnId = 818, tableId = 26, name = "flux_SG",
		description = "Calibrated flux for Small Galaxy model.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 30;
	...
	INSERT INTO md_Column
	SET columnId = 819, tableId = 26, name = "flux_SG_Sigma",
		description = "Uncertainty of flux_SG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 31;
	...
	INSERT INTO md_Column
	SET columnId = 820, tableId = 26, name = "flux_CSG",
		description = "Calibrated flux for Cannonical Small Galaxy model.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 32;
	...
	INSERT INTO md_Column
	SET columnId = 821, tableId = 26, name = "flux_CSG_Sigma",
		description = "Uncertainly of flux_CSG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 33;
	...
	INSERT INTO md_Column
	SET columnId = 822, tableId = 26, name = "extendedness",
		description = "Probability that this source is an extended source. Valid range: 0-1, where 1 indicates an extended source with 100% probability.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 34;
	...
	INSERT INTO md_Column
	SET columnId = 823, tableId = 26, name = "galExtinction",
		description = "Galactic extinction.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 35;
	...
	INSERT INTO md_Column
	SET columnId = 824, tableId = 26, name = "sersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 825, tableId = 26, name = "sersicN_SG_Sigma",
		description = "Uncertainty of sersicN_SG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 37;
	...
	INSERT INTO md_Column
	SET columnId = 826, tableId = 26, name = "e1_SG",
		description = "Ellipticity for Small Galaxy model.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 38;
	...
	INSERT INTO md_Column
	SET columnId = 827, tableId = 26, name = "e1_SG_Sigma",
		description = "Uncertainty of e1_SG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 39;
	...
	INSERT INTO md_Column
	SET columnId = 828, tableId = 26, name = "e2_SG",
		description = "Ellipticity for Small Galaxy model.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 40;
	...
	INSERT INTO md_Column
	SET columnId = 829, tableId = 26, name = "e2_SG_Sigma",
		description = "Uncertainty of e2_SG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 41;
	...
	INSERT INTO md_Column
	SET columnId = 830, tableId = 26, name = "radius_SG",
		description = "Size of Small Galaxy model.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 42;
	...
	INSERT INTO md_Column
	SET columnId = 831, tableId = 26, name = "radius_SG_Sigma",
		description = "Uncertainty of radius_SG.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 43;
	...
	INSERT INTO md_Column
	SET columnId = 832, tableId = 26, name = "midPoint",
		description = "Corrected midPoint of the exposure (tai).&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 44;
	...
	INSERT INTO md_Column
	SET columnId = 833, tableId = 26, name = "apCorrection",
		description = "Photometric correction: aperture correction.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 45;
	...
	INSERT INTO md_Column
	SET columnId = 834, tableId = 26, name = "grayExtinction",
		description = "Photometric correction: gray extinction.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 46;
	...
	INSERT INTO md_Column
	SET columnId = 835, tableId = 26, name = "nonGrayExtinction",
		description = "Photometric correction: non gray extinction.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 47;
	...
	INSERT INTO md_Column
	SET columnId = 836, tableId = 26, name = "momentIx",
	...
	INSERT INTO md_Column
	SET columnId = 837, tableId = 26, name = "momentIxSigma",
		description = "Uncertainty of momentIx.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 49;
	...
	INSERT INTO md_Column
	SET columnId = 838, tableId = 26, name = "momentIy",
		description = "Adaptive first moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 50;
	...
	INSERT INTO md_Column
	SET columnId = 839, tableId = 26, name = "momentIySigma",
		description = "Uncertainty of momentIy.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 51;
	...
	INSERT INTO md_Column
	SET columnId = 840, tableId = 26, name = "momentIxx",
		description = "Adaptive second moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 52;
	...
	INSERT INTO md_Column
	SET columnId = 841, tableId = 26, name = "momentIxxSigma",
		description = "Uncertainty of momentIxx.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 53;
	...
	INSERT INTO md_Column
	SET columnId = 842, tableId = 26, name = "momentIyy",
		description = "Adaptive second moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 54;
	...
	INSERT INTO md_Column
	SET columnId = 843, tableId = 26, name = "momentIyySigma",
		description = "Uncertainty of momentIyy.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 55;
	...
	INSERT INTO md_Column
	SET columnId = 844, tableId = 26, name = "momentIxy",
		description = "Adaptive second moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 56;
	...
	INSERT INTO md_Column
	SET columnId = 845, tableId = 26, name = "momentIxySigma",
	...
	INSERT INTO md_Column
	SET columnId = 846, tableId = 26, name = "flags",
		description = "Flags.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 58;
	...
	INSERT INTO md_Column
	SET columnId = 847, tableId = 26, name = "_chunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 59;
	...
	INSERT INTO md_Column
	SET columnId = 848, tableId = 26, name = "_subChunkId",
		description = "Internal column used by qserv.&#xA;",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 60;
...
INSERT INTO md_Table
SET tableId = 27, name = "Visit",
	description = "Defines a single Visit. 1 row per LSST visit.";

	INSERT INTO md_Column
	SET columnId = 849, tableId = 27, name = "visitId",
...
INSERT INTO md_Table
SET tableId = 28, name = "_MovingObjectToType",
	description = "Mapping: moving object --&amp;gt; types, with probabilities";

	INSERT INTO md_Column
	SET columnId = 850, tableId = 28, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 851, tableId = 28, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 852, tableId = 28, name = "probability",
...
INSERT INTO md_Table
SET tableId = 29, name = "_ObjectToType",
	description = "Mapping Object --&amp;gt; types, with probabilities";

	INSERT INTO md_Column
	SET columnId = 853, tableId = 29, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 854, tableId = 29, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 855, tableId = 29, name = "probability",
...
INSERT INTO md_Table
SET tableId = 30, name = "_Raw_Ccd_ExposureToVisit",
	description = "Mapping table: Raw_Ccd_Exposure --&amp;gt; visit&#xA;";

	INSERT INTO md_Column
	SET columnId = 856, tableId = 30, name = "visitId",
	...
	INSERT INTO md_Column
	SET columnId = 857, tableId = 30, name = "ccdExposureId",
...
INSERT INTO md_Table
SET tableId = 31, name = "_mops_Config",
	...
	INSERT INTO md_Column
	SET columnId = 858, tableId = 31, name = "configId",
	...
	INSERT INTO md_Column
	SET columnId = 859, tableId = 31, name = "configText",
...
INSERT INTO md_Table
SET tableId = 32, name = "_mops_EonQueue",
	...
	INSERT INTO md_Column
	SET columnId = 860, tableId = 32, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 861, tableId = 32, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 862, tableId = 32, name = "insertTime",
	...
	INSERT INTO md_Column
	SET columnId = 863, tableId = 32, name = "status",
...
SET tableId = 33, name = "_mops_MoidQueue",
	...
	INSERT INTO md_Column
	SET columnId = 865, tableId = 33, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 866, tableId = 33, name = "eventId",
		description = "Referring history event causing insertion",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 867, tableId = 33, name = "insertTime",
		description = "Wall clock time object was queued",
		type = "TIMESTAMP",
		notNull = 1,
		defaultValue = "CURRENT_TIMESTAMP",
...
SET tableId = 34, name = "_qservChunkMap",
	...
	INSERT INTO md_Column
	SET columnId = 869, tableId = 34, name = "raMax",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 870, tableId = 34, name = "declMin",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 871, tableId = 34, name = "declMax",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 872, tableId = 34, name = "chunkId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 873, tableId = 34, name = "objCount",
...
INSERT INTO md_Table
SET tableId = 35, name = "_qservObjectIdMap",
	description = "Internal table used by qserv. Keeps mapping: objectId --&amp;gt; chunkId+subChunkId.&#xA;";

	INSERT INTO md_Column
	SET columnId = 874, tableId = 35, name = "objectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 875, tableId = 35, name = "chunkId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 876, tableId = 35, name = "subChunkId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 3;
...
SET tableId = 36, name = "_qservSubChunkMap",
	...
	INSERT INTO md_Column
	SET columnId = 878, tableId = 36, name = "raMax",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 879, tableId = 36, name = "declMin",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 880, tableId = 36, name = "declMax",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 881, tableId = 36, name = "chunkId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 882, tableId = 36, name = "subChunkId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 883, tableId = 36, name = "objCount",
...
INSERT INTO md_Table
SET tableId = 38, name = "_tmpl_IdPair",
	description = "Template table. Schema for list of id pairs.";

	INSERT INTO md_Column
	SET columnId = 885, tableId = 38, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 886, tableId = 38, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
INSERT INTO md_Table
SET tableId = 39, name = "_tmpl_MatchPair",
	description = "Template table. Schema for per-visit match result tables.";

	INSERT INTO md_Column
	SET columnId = 887, tableId = 39, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 888, tableId = 39, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 889, tableId = 39, name = "distance",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 3;
...
INSERT INTO md_Table
SET tableId = 40, name = "_tmpl_mops_Ephemeris",
	engine = "MyISAM";

	INSERT INTO md_Column
	SET columnId = 890, tableId = 40, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 891, tableId = 40, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 892, tableId = 40, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 893, tableId = 40, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 894, tableId = 40, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 895, tableId = 40, name = "smia",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 896, tableId = 40, name = "smaa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 897, tableId = 40, name = "pa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 898, tableId = 40, name = "mag",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 9;
...
INSERT INTO md_Table
SET tableId = 41, name = "_tmpl_mops_Prediction",
	engine = "MyISAM";

	INSERT INTO md_Column
	SET columnId = 899, tableId = 41, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 900, tableId = 41, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 901, tableId = 41, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 902, tableId = 41, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 903, tableId = 41, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 904, tableId = 41, name = "smia",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 905, tableId = 41, name = "smaa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 906, tableId = 41, name = "pa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 907, tableId = 41, name = "mag",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 908, tableId = 41, name = "magErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
...
INSERT INTO md_Table
SET tableId = 42, name = "mops_Event";

	INSERT INTO md_Column
	SET columnId = 909, tableId = 42, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 910, tableId = 42, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 911, tableId = 42, name = "eventType",
	...
	INSERT INTO md_Column
	SET columnId = 912, tableId = 42, name = "eventTime",
	...
	INSERT INTO md_Column
	SET columnId = 913, tableId = 42, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 914, tableId = 42, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 915, tableId = 42, name = "orbitCode",
	...
	INSERT INTO md_Column
	SET columnId = 916, tableId = 42, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 917, tableId = 42, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 918, tableId = 42, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 919, tableId = 42, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 920, tableId = 42, name = "ssmId",
...
INSERT INTO md_Table
SET tableId = 43, name = "mops_Event_OrbitDerivation",
	...
	INSERT INTO md_Column
	SET columnId = 921, tableId = 43, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 922, tableId = 43, name = "trackletId",
...
INSERT INTO md_Table
SET tableId = 44, name = "mops_Event_OrbitIdentification",
	...
	INSERT INTO md_Column
	SET columnId = 923, tableId = 44, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 924, tableId = 44, name = "childObjectId",
...
INSERT INTO md_Table
SET tableId = 45, name = "mops_Event_TrackletAttribution",
	description = "Table for associating tracklets with attribution events (one tracklet per event).";

	INSERT INTO md_Column
	SET columnId = 925, tableId = 45, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 926, tableId = 45, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 927, tableId = 45, name = "ephemerisDistance",
	...
	INSERT INTO md_Column
	SET columnId = 928, tableId = 45, name = "ephemerisUncertainty",
...
SET tableId = 46, name = "mops_Event_TrackletPrecovery",
	...
	INSERT INTO md_Column
	SET columnId = 930, tableId = 46, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 931, tableId = 46, name = "ephemerisDistance",
		description = "Predicted position minus actual, arcsecs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 932, tableId = 46, name = "ephemerisUncertainty",
		description = "Predicted error ellipse semi-major axis, arcsecs",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 47, name = "mops_Event_TrackletRemoval",
	description = "Table for associating tracklets with removal events (one removal per event).";

	INSERT INTO md_Column
	SET columnId = 933, tableId = 47, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 934, tableId = 47, name = "trackletId",
...
INSERT INTO md_Table
SET tableId = 48, name = "mops_MovingObjectToTracklet",
	description = "Current membership of tracklets and moving objects.";

	INSERT INTO md_Column
	SET columnId = 935, tableId = 48, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 936, tableId = 48, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
INSERT INTO md_Table
SET tableId = 49, name = "mops_SSM",
	description = "Table that contains synthetic solar system model (SSM) objects.";

	INSERT INTO md_Column
	SET columnId = 937, tableId = 49, name = "ssmId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 938, tableId = 49, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 939, tableId = 49, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 940, tableId = 49, name = "e",
		description = "eccentricity e (dimensionless)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 941, tableId = 49, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 942, tableId = 49, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 943, tableId = 49, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 944, tableId = 49, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 945, tableId = 49, name = "epoch",
		description = "epoch of osculating elements, MJD (UTC)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 946, tableId = 49, name = "h_v",
		description = "Absolute magnitude",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 947, tableId = 49, name = "h_ss",
		description = "??",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 948, tableId = 49, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 949, tableId = 49, name = "albedo",
		description = "Albedo, dimensionless",
		type = "DOUBLE",
		notNull = 0,
		unit = "-",
	...
	INSERT INTO md_Column
	SET columnId = 950, tableId = 49, name = "ssmObjectName",
...
SET tableId = 50, name = "mops_SSMDesc",
	...
	INSERT INTO md_Column
	SET columnId = 952, tableId = 50, name = "prefix",
	...
	INSERT INTO md_Column
	SET columnId = 953, tableId = 50, name = "description",
...
INSERT INTO md_Table
SET tableId = 51, name = "mops_TrackToTracklet";

	INSERT INTO md_Column
	SET columnId = 954, tableId = 51, name = "trackId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 955, tableId = 51, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
INSERT INTO md_Table
SET tableId = 52, name = "mops_Tracklet";

	INSERT INTO md_Column
	SET columnId = 956, tableId = 52, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 957, tableId = 52, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 958, tableId = 52, name = "procHistoryId",
		description = "Pointer to processing history (prv_ProcHistory)",
		type = "INT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 959, tableId = 52, name = "ssmId",
		description = "Matching SSM ID for clean classifications",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 960, tableId = 52, name = "velRa",
	...
	INSERT INTO md_Column
	SET columnId = 961, tableId = 52, name = "velRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 962, tableId = 52, name = "velDecl",
	...
	INSERT INTO md_Column
	SET columnId = 963, tableId = 52, name = "velDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 964, tableId = 52, name = "velTot",
	...
	INSERT INTO md_Column
	SET columnId = 965, tableId = 52, name = "accRa",
	...
	INSERT INTO md_Column
	SET columnId = 966, tableId = 52, name = "accRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 967, tableId = 52, name = "accDecl",
	...
	INSERT INTO md_Column
	SET columnId = 968, tableId = 52, name = "accDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 969, tableId = 52, name = "extEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 970, tableId = 52, name = "extRa",
	...
	INSERT INTO md_Column
	SET columnId = 971, tableId = 52, name = "extRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 972, tableId = 52, name = "extDecl",
	...
	INSERT INTO md_Column
	SET columnId = 973, tableId = 52, name = "extDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 974, tableId = 52, name = "extMag",
	...
	INSERT INTO md_Column
	SET columnId = 975, tableId = 52, name = "extMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 976, tableId = 52, name = "probability",
	...
	INSERT INTO md_Column
	SET columnId = 977, tableId = 52, name = "status",
	...
	INSERT INTO md_Column
	SET columnId = 978, tableId = 52, name = "classification",
...
INSERT INTO md_Table
SET tableId = 53, name = "mops_TrackletToDiaSource",
	description = "Table maintaining many-to-many relationship between tracklets and detections.&#xA;";

	INSERT INTO md_Column
	SET columnId = 979, tableId = 53, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 980, tableId = 53, name = "diaSourceId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
INSERT INTO md_Table
SET tableId = 54, name = "prv_Activity";

	INSERT INTO md_Column
	SET columnId = 981, tableId = 54, name = "activityId",
	...
	INSERT INTO md_Column
	SET columnId = 982, tableId = 54, name = "offset",
	...
	INSERT INTO md_Column
	SET columnId = 983, tableId = 54, name = "name",
	...
	INSERT INTO md_Column
	SET columnId = 984, tableId = 54, name = "type",
	...
	INSERT INTO md_Column
	SET columnId = 985, tableId = 54, name = "platform",
...
INSERT INTO md_Table
SET tableId = 55, name = "prv_Filter",
	engine = "MyISAM",
	description = "One row per color - the table will have 6 rows";

	INSERT INTO md_Column
	SET columnId = 986, tableId = 55, name = "filterId",
		description = "Unique id.",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 987, tableId = 55, name = "focalPlaneId",
	...
	INSERT INTO md_Column
	SET columnId = 988, tableId = 55, name = "name",
	...
	INSERT INTO md_Column
	SET columnId = 989, tableId = 55, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 990, tableId = 55, name = "clam",
	...
	INSERT INTO md_Column
	SET columnId = 991, tableId = 55, name = "bw",
...
INSERT INTO md_Table
SET tableId = 56, name = "prv_PolicyFile";

	INSERT INTO md_Column
	SET columnId = 992, tableId = 56, name = "policyFileId",
	...
	INSERT INTO md_Column
	SET columnId = 993, tableId = 56, name = "pathName",
	...
	INSERT INTO md_Column
	SET columnId = 994, tableId = 56, name = "hashValue",
	...
	INSERT INTO md_Column
	SET columnId = 995, tableId = 56, name = "modifiedDate",
...
INSERT INTO md_Table
SET tableId = 57, name = "prv_PolicyKey";

	INSERT INTO md_Column
	SET columnId = 996, tableId = 57, name = "policyKeyId",
	...
	INSERT INTO md_Column
	SET columnId = 997, tableId = 57, name = "policyFileId",
	...
	INSERT INTO md_Column
	SET columnId = 998, tableId = 57, name = "keyName",
	...
	INSERT INTO md_Column
	SET columnId = 999, tableId = 57, name = "keyType",
...
INSERT INTO md_Table
SET tableId = 58, name = "prv_Run";

	INSERT INTO md_Column
	SET columnId = 1000, tableId = 58, name = "offset",
		type = "MEDIUMINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 1001, tableId = 58, name = "runId",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;
...
INSERT INTO md_Table
SET tableId = 59, name = "prv_SoftwarePackage";

	INSERT INTO md_Column
	SET columnId = 1002, tableId = 59, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 1003, tableId = 59, name = "packageName",
		type = "VARCHAR(64)",
		notNull = 1,
		displayOrder = 2;
...
INSERT INTO md_Table
SET tableId = 60, name = "prv_cnf_PolicyKey";

	INSERT INTO md_Column
	SET columnId = 1004, tableId = 60, name = "policyKeyId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 1005, tableId = 60, name = "value",
		type = "TEXT",
		notNull = 0,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 1006, tableId = 60, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 1007, tableId = 60, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;
...
INSERT INTO md_Table
SET tableId = 61, name = "prv_cnf_SoftwarePackage";

	INSERT INTO md_Column
	SET columnId = 1008, tableId = 61, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 1009, tableId = 61, name = "version",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 1010, tableId = 61, name = "directory",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 1011, tableId = 61, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 1012, tableId = 61, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 5;
...
INSERT INTO md_Table
SET tableId = 62, name = "sdqa_ImageStatus",
	description = "Unique set of status names and their definitions, e.g. &quot;passed&quot;, &quot;failed&quot;, etc. ";

	INSERT INTO md_Column
	SET columnId = 1013, tableId = 62, name = "sdqa_imageStatusId",
	...
	INSERT INTO md_Column
	SET columnId = 1014, tableId = 62, name = "statusName",
	...
	INSERT INTO md_Column
	SET columnId = 1015, tableId = 62, name = "definition",
...
INSERT INTO md_Table
SET tableId = 63, name = "sdqa_Metric",
	...
	INSERT INTO md_Column
	SET columnId = 1016, tableId = 63, name = "sdqa_metricId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 1017, tableId = 63, name = "metricName",
	...
	INSERT INTO md_Column
	SET columnId = 1018, tableId = 63, name = "physicalUnits",
	...
	INSERT INTO md_Column
	SET columnId = 1019, tableId = 63, name = "dataType",
	...
	INSERT INTO md_Column
	SET columnId = 1020, tableId = 63, name = "definition",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 5;
...
INSERT INTO md_Table
SET tableId = 64, name = "sdqa_Rating_ForScienceAmpExposure",
	...
	INSERT INTO md_Column
	SET columnId = 1021, tableId = 64, name = "sdqa_ratingId",
	...
	INSERT INTO md_Column
	SET columnId = 1022, tableId = 64, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 1023, tableId = 64, name = "sdqa_thresholdId",
	...
	INSERT INTO md_Column
	SET columnId = 1024, tableId = 64, name = "ampExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 1025, tableId = 64, name = "metricValue",
	...
	INSERT INTO md_Column
	SET columnId = 1026, tableId = 64, name = "metricSigma",
...
INSERT INTO md_Table
SET tableId = 65, name = "sdqa_Rating_ForScienceCcdExposure",
	description = "Various SDQA ratings for a given ScienceCcdExposure.&#xA;";

	INSERT INTO md_Column
	SET columnId = 1027, tableId = 65, name = "sdqa_ratingId",
		description = "Primary key. Auto-increment is used, we define a composite unique key, so potential duplicates will be captured.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 1028, tableId = 65, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 1029, tableId = 65, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 1030, tableId = 65, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 1031, tableId = 65, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 1032, tableId = 65, name = "metricSigma",
		description = "Uncertainty of the value of this metric.&#xA;",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
INSERT INTO md_Table
SET tableId = 66, name = "sdqa_Rating_ForSnapCcdExposure";

	INSERT INTO md_Column
	SET columnId = 1033, tableId = 66, name = "sdqa_ratingId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 1034, tableId = 66, name = "sdqa_metricId",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 1035, tableId = 66, name = "sdqa_thresholdId",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 1036, tableId = 66, name = "ccdExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 1037, tableId = 66, name = "metricValue",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 1038, tableId = 66, name = "metricSigma",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
INSERT INTO md_Table
SET tableId = 67, name = "sdqa_Threshold",
	...
	INSERT INTO md_Column
	SET columnId = 1039, tableId = 67, name = "sdqa_thresholdId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 1040, tableId = 67, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 1041, tableId = 67, name = "upperThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 1042, tableId = 67, name = "lowerThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 1043, tableId = 67, name = "createdDate",
