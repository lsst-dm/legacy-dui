...
CREATE TABLE AAA_Version_DC3b_3_1_65 (version CHAR);
...
SET tableId = 4, name = "Filter";
	...
	INSERT INTO md_Column
	SET columnId = 65, tableId = 4, name = "filterName",
	...
	INSERT INTO md_Column
	SET columnId = 66, tableId = 4, name = "photClam",
	...
	INSERT INTO md_Column
	SET columnId = 67, tableId = 4, name = "photBW",
...
SET tableId = 5, name = "ForcedDiaSource",
	...
	INSERT INTO md_Column
	SET columnId = 68, tableId = 5, name = "objectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 69, tableId = 5, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 70, tableId = 5, name = "sky",
	...
	INSERT INTO md_Column
	SET columnId = 71, tableId = 5, name = "skySigma",
	...
	INSERT INTO md_Column
	SET columnId = 72, tableId = 5, name = "psfFlux",
		description = "Psf flux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 73, tableId = 5, name = "psfFluxSigma",
	...
	INSERT INTO md_Column
	SET columnId = 74, tableId = 5, name = "apFlux",
		description = "Aperture flux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 7;
	...
	INSERT INTO md_Column
	SET columnId = 75, tableId = 5, name = "apFluxSigma",
		description = "Uncertainty of apFlux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 8;
	...
	INSERT INTO md_Column
	SET columnId = 76, tableId = 5, name = "modelFlux",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 77, tableId = 5, name = "modelFluxSigma",
	...
	INSERT INTO md_Column
	SET columnId = 78, tableId = 5, name = "modelFluxCanonicalBand",
	...
	INSERT INTO md_Column
	SET columnId = 79, tableId = 5, name = "modelFluxCanonicalBandSigma",
	...
	INSERT INTO md_Column
	SET columnId = 80, tableId = 5, name = "psfLnL",
		description = "ln(likelihood) of being a PSF.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 81, tableId = 5, name = "modelLSLnL",
	...
	INSERT INTO md_Column
	SET columnId = 82, tableId = 5, name = "modelSGLnL",
	...
	INSERT INTO md_Column
	SET columnId = 83, tableId = 5, name = "modelSOLnL",
	...
	INSERT INTO md_Column
	SET columnId = 84, tableId = 5, name = "modelLOLnL",
	...
	INSERT INTO md_Column
	SET columnId = 85, tableId = 5, name = "flags",
		description = "Flags.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 18;
...
SET tableId = 6, name = "ForcedSource",
	...
	INSERT INTO md_Column
	SET columnId = 86, tableId = 6, name = "objectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 87, tableId = 6, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 88, tableId = 6, name = "sky",
		description = "Sky background.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 89, tableId = 6, name = "skySigma",
		description = "Uncertainty of sky.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 90, tableId = 6, name = "psfFlux",
		description = "Psf flux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 91, tableId = 6, name = "psfFluxSigma",
		description = "Uncertainty of psf.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 6;
	...
	INSERT INTO md_Column
	SET columnId = 92, tableId = 6, name = "apFlux",
		description = "Aperture flux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 7;
	...
	INSERT INTO md_Column
	SET columnId = 93, tableId = 6, name = "apFluxSigma",
		description = "Uncertainty of apFlux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 8;
	...
	INSERT INTO md_Column
	SET columnId = 94, tableId = 6, name = "modelFlux",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 95, tableId = 6, name = "modelFluxSigma",
		description = "Uncertainty of modelFlux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 96, tableId = 6, name = "modelFluxCanonicalBand",
		description = "It is the flux in this band using  the model from the &quot;canonical band&quot;. This will be specified by a Policy file. RHL would expect it to usually be i, but we  have to be careful for objects that are not detected in that band.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 97, tableId = 6, name = "modelFluxCanonicalBandSigma",
		description = "Uncertainty of modelFluxCanonicalBand.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 12;
	...
	INSERT INTO md_Column
	SET columnId = 98, tableId = 6, name = "psfLnL",
		description = "ln(likelihood) of being a PSF.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 99, tableId = 6, name = "modelLSLnL",
	...
	INSERT INTO md_Column
	SET columnId = 100, tableId = 6, name = "modelSGLnL",
	...
	INSERT INTO md_Column
	SET columnId = 101, tableId = 6, name = "modelSOLnL",
	...
	INSERT INTO md_Column
	SET columnId = 102, tableId = 6, name = "modelLOLnL",
	...
	INSERT INTO md_Column
	SET columnId = 103, tableId = 6, name = "flags",
		description = "Flags.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 18;
...
SET tableId = 7, name = "MovingObject",
	...
	INSERT INTO md_Column
	SET columnId = 104, tableId = 7, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 105, tableId = 7, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 106, tableId = 7, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 107, tableId = 7, name = "taxonomicTypeId",
	...
	INSERT INTO md_Column
	SET columnId = 108, tableId = 7, name = "ssmObjectName",
	...
	INSERT INTO md_Column
	SET columnId = 109, tableId = 7, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 110, tableId = 7, name = "e",
	...
	INSERT INTO md_Column
	SET columnId = 111, tableId = 7, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 112, tableId = 7, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 113, tableId = 7, name = "meanAnom",
	...
	INSERT INTO md_Column
	SET columnId = 114, tableId = 7, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 115, tableId = 7, name = "distPeri",
	...
	INSERT INTO md_Column
	SET columnId = 116, tableId = 7, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 117, tableId = 7, name = "epoch",
	...
	INSERT INTO md_Column
	SET columnId = 118, tableId = 7, name = "h_v",
	...
	INSERT INTO md_Column
	SET columnId = 119, tableId = 7, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 120, tableId = 7, name = "rotationPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 121, tableId = 7, name = "rotationEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 122, tableId = 7, name = "albedo",
	...
	INSERT INTO md_Column
	SET columnId = 123, tableId = 7, name = "poleLat",
	...
	INSERT INTO md_Column
	SET columnId = 124, tableId = 7, name = "poleLon",
	...
	INSERT INTO md_Column
	SET columnId = 125, tableId = 7, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 126, tableId = 7, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 127, tableId = 7, name = "orbFitResidual",
	...
	INSERT INTO md_Column
	SET columnId = 128, tableId = 7, name = "orbFitChi2",
	...
	INSERT INTO md_Column
	SET columnId = 129, tableId = 7, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 130, tableId = 7, name = "ssmId",
	...
	INSERT INTO md_Column
	SET columnId = 131, tableId = 7, name = "mopsStatus",
	...
	INSERT INTO md_Column
	SET columnId = 132, tableId = 7, name = "stablePass",
	...
	INSERT INTO md_Column
	SET columnId = 133, tableId = 7, name = "timeCreated",
	...
	INSERT INTO md_Column
	SET columnId = 134, tableId = 7, name = "uMag",
	...
	INSERT INTO md_Column
	SET columnId = 135, tableId = 7, name = "uMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 136, tableId = 7, name = "uAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 137, tableId = 7, name = "uPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 138, tableId = 7, name = "gMag",
	...
	INSERT INTO md_Column
	SET columnId = 139, tableId = 7, name = "gMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 140, tableId = 7, name = "gAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 141, tableId = 7, name = "gPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 142, tableId = 7, name = "rMag",
	...
	INSERT INTO md_Column
	SET columnId = 143, tableId = 7, name = "rMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 144, tableId = 7, name = "rAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 145, tableId = 7, name = "rPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 146, tableId = 7, name = "iMag",
	...
	INSERT INTO md_Column
	SET columnId = 147, tableId = 7, name = "iMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 148, tableId = 7, name = "iAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 149, tableId = 7, name = "iPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 150, tableId = 7, name = "zMag",
	...
	INSERT INTO md_Column
	SET columnId = 151, tableId = 7, name = "zMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 152, tableId = 7, name = "zAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 153, tableId = 7, name = "zPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 154, tableId = 7, name = "yMag",
	...
	INSERT INTO md_Column
	SET columnId = 155, tableId = 7, name = "yMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 156, tableId = 7, name = "yAmplitude",
	...
	INSERT INTO md_Column
	SET columnId = 157, tableId = 7, name = "yPeriod",
	...
	INSERT INTO md_Column
	SET columnId = 158, tableId = 7, name = "flag",
	...
	INSERT INTO md_Column
	SET columnId = 159, tableId = 7, name = "src01",
	...
	INSERT INTO md_Column
	SET columnId = 160, tableId = 7, name = "src02",
	...
	INSERT INTO md_Column
	SET columnId = 161, tableId = 7, name = "src03",
	...
	INSERT INTO md_Column
	SET columnId = 162, tableId = 7, name = "src04",
	...
	INSERT INTO md_Column
	SET columnId = 163, tableId = 7, name = "src05",
	...
	INSERT INTO md_Column
	SET columnId = 164, tableId = 7, name = "src06",
	...
	INSERT INTO md_Column
	SET columnId = 165, tableId = 7, name = "src07",
	...
	INSERT INTO md_Column
	SET columnId = 166, tableId = 7, name = "src08",
	...
	INSERT INTO md_Column
	SET columnId = 167, tableId = 7, name = "src09",
	...
	INSERT INTO md_Column
	SET columnId = 168, tableId = 7, name = "src10",
	...
	INSERT INTO md_Column
	SET columnId = 169, tableId = 7, name = "src11",
	...
	INSERT INTO md_Column
	SET columnId = 170, tableId = 7, name = "src12",
	...
	INSERT INTO md_Column
	SET columnId = 171, tableId = 7, name = "src13",
	...
	INSERT INTO md_Column
	SET columnId = 172, tableId = 7, name = "src14",
	...
	INSERT INTO md_Column
	SET columnId = 173, tableId = 7, name = "src15",
	...
	INSERT INTO md_Column
	SET columnId = 174, tableId = 7, name = "src16",
	...
	INSERT INTO md_Column
	SET columnId = 175, tableId = 7, name = "src17",
	...
	INSERT INTO md_Column
	SET columnId = 176, tableId = 7, name = "src18",
	...
	INSERT INTO md_Column
	SET columnId = 177, tableId = 7, name = "src19",
	...
	INSERT INTO md_Column
	SET columnId = 178, tableId = 7, name = "src20",
	...
	INSERT INTO md_Column
	SET columnId = 179, tableId = 7, name = "src21",
	...
	INSERT INTO md_Column
	SET columnId = 180, tableId = 7, name = "convCode",
	...
	INSERT INTO md_Column
	SET columnId = 181, tableId = 7, name = "o_minus_c",
	...
	INSERT INTO md_Column
	SET columnId = 182, tableId = 7, name = "moid1",
	...
	INSERT INTO md_Column
	SET columnId = 183, tableId = 7, name = "moidLong1",
	...
	INSERT INTO md_Column
	SET columnId = 184, tableId = 7, name = "moid2",
	...
	INSERT INTO md_Column
	SET columnId = 185, tableId = 7, name = "moidLong2",
	...
	INSERT INTO md_Column
	SET columnId = 186, tableId = 7, name = "arcLengthDays",
...
SET tableId = 8, name = "Object",
	...
	INSERT INTO md_Column
	SET columnId = 187, tableId = 8, name = "objectId",
		description = "Unique id.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 188, tableId = 8, name = "subChunkId",
	...
	INSERT INTO md_Column
	SET columnId = 190, tableId = 8, name = "ra_PS",
	...
	INSERT INTO md_Column
	SET columnId = 191, tableId = 8, name = "ra_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 192, tableId = 8, name = "decl_PS",
	...
	INSERT INTO md_Column
	SET columnId = 193, tableId = 8, name = "decl_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 194, tableId = 8, name = "radecl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 195, tableId = 8, name = "ra_SG",
	...
	INSERT INTO md_Column
	SET columnId = 196, tableId = 8, name = "ra_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 197, tableId = 8, name = "decl_SG",
	...
	INSERT INTO md_Column
	SET columnId = 198, tableId = 8, name = "decl_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 199, tableId = 8, name = "radecl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 200, tableId = 8, name = "raRange",
	...
	INSERT INTO md_Column
	SET columnId = 201, tableId = 8, name = "declRange",
	...
	INSERT INTO md_Column
	SET columnId = 202, tableId = 8, name = "muRa_PS",
	...
	INSERT INTO md_Column
	SET columnId = 203, tableId = 8, name = "muRa_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 204, tableId = 8, name = "muDecl_PS",
	...
	INSERT INTO md_Column
	SET columnId = 205, tableId = 8, name = "muDecl_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 206, tableId = 8, name = "muRaDecl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 207, tableId = 8, name = "parallax_PS",
	...
	INSERT INTO md_Column
	SET columnId = 208, tableId = 8, name = "parallax_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 209, tableId = 8, name = "cannonicalFilterId",
	...
	INSERT INTO md_Column
	SET columnId = 210, tableId = 8, name = "extendedness",
	...
	INSERT INTO md_Column
	SET columnId = 211, tableId = 8, name = "earliestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 212, tableId = 8, name = "latestObsTime",
	...
	INSERT INTO md_Column
	SET columnId = 213, tableId = 8, name = "uNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 214, tableId = 8, name = "uVarProb",
		description = "Probability of variability for u filter. Valid range: 0-1, where 1 indicates a variable object with 100% probability.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;

	INSERT INTO md_Column
	SET columnId = 215, tableId = 8, name = "uRaOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 216, tableId = 8, name = "uRaOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 217, tableId = 8, name = "uDeclOffset_PS",
	...
	INSERT INTO md_Column
	SET columnId = 218, tableId = 8, name = "uDeclOffset_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 219, tableId = 8, name = "uRaDeclOffset_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 220, tableId = 8, name = "uRaOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 221, tableId = 8, name = "uRaOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 222, tableId = 8, name = "uDeclOffset_SG",
	...
	INSERT INTO md_Column
	SET columnId = 223, tableId = 8, name = "uDeclOffset_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 224, tableId = 8, name = "uRaDeclOffset_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 225, tableId = 8, name = "uLnL_PS",
	...
	INSERT INTO md_Column
	SET columnId = 226, tableId = 8, name = "uLnL_SG",
	...
	INSERT INTO md_Column
	SET columnId = 227, tableId = 8, name = "uFlux_PS",
	...
	INSERT INTO md_Column
	SET columnId = 228, tableId = 8, name = "uFlux_PS_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 229, tableId = 8, name = "uFlux_SG",
	...
	INSERT INTO md_Column
	SET columnId = 230, tableId = 8, name = "uFlux_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 231, tableId = 8, name = "uFlux_CSG",
	...
	INSERT INTO md_Column
	SET columnId = 232, tableId = 8, name = "uFlux_CSG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 233, tableId = 8, name = "uTimescale",
	...
	INSERT INTO md_Column
	SET columnId = 234, tableId = 8, name = "uSersicN_SG",
	...
	INSERT INTO md_Column
	SET columnId = 235, tableId = 8, name = "uSersicN_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 236, tableId = 8, name = "uE1_SG",
	...
	INSERT INTO md_Column
	SET columnId = 237, tableId = 8, name = "uE1_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 238, tableId = 8, name = "uE2_SG",
		description = "Ellipticity for Small Galaxy model for u filter.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 52;
	...
	INSERT INTO md_Column
	SET columnId = 239, tableId = 8, name = "uE2_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 240, tableId = 8, name = "uRadius_SG",
	...
	INSERT INTO md_Column
	SET columnId = 241, tableId = 8, name = "uRadius_SG_Sigma",
	...
	INSERT INTO md_Column
	SET columnId = 242, tableId = 8, name = "uFlux_ra_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 243, tableId = 8, name = "uFlux_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 244, tableId = 8, name = "uRa_decl_PS_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 245, tableId = 8, name = "uFlux_ra_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 246, tableId = 8, name = "uFlux_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 247, tableId = 8, name = "uFlux_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 248, tableId = 8, name = "uFlux_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 249, tableId = 8, name = "uFlux_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 250, tableId = 8, name = "uFlux_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 251, tableId = 8, name = "uRa_decl_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 252, tableId = 8, name = "uRa_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 253, tableId = 8, name = "uRa_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 254, tableId = 8, name = "uRa_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 255, tableId = 8, name = "uRa_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 256, tableId = 8, name = "uDecl_SersicN_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 257, tableId = 8, name = "uDecl_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 258, tableId = 8, name = "uDecl_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 259, tableId = 8, name = "uDecl_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 260, tableId = 8, name = "uSersicN_e1_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 261, tableId = 8, name = "uSersicN_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 262, tableId = 8, name = "uSersicN_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 263, tableId = 8, name = "uE1_e2_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 264, tableId = 8, name = "uE1_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 265, tableId = 8, name = "uE2_radius_SG_Cov",
	...
	INSERT INTO md_Column
	SET columnId = 266, tableId = 8, name = "uFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 80;
...
SET tableId = 9, name = "ObjectType",
	...
	INSERT INTO md_Column
	SET columnId = 267, tableId = 9, name = "typeId",
		description = "Unique id.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 268, tableId = 9, name = "description",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 2;
...
SET tableId = 10, name = "Raw_Amp_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 269, tableId = 10, name = "rawAmpExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 270, tableId = 10, name = "rawCcdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 271, tableId = 10, name = "rawFpaExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 272, tableId = 10, name = "ampId",
	...
	INSERT INTO md_Column
	SET columnId = 273, tableId = 10, name = "radecSys",
	...
	INSERT INTO md_Column
	SET columnId = 274, tableId = 10, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 275, tableId = 10, name = "ctype1",
	...
	INSERT INTO md_Column
	SET columnId = 276, tableId = 10, name = "ctype2",
	...
	INSERT INTO md_Column
	SET columnId = 277, tableId = 10, name = "crpix1",
	...
	INSERT INTO md_Column
	SET columnId = 278, tableId = 10, name = "crpix2",
	...
	INSERT INTO md_Column
	SET columnId = 279, tableId = 10, name = "crval1",
	...
	INSERT INTO md_Column
	SET columnId = 280, tableId = 10, name = "crval2",
	...
	INSERT INTO md_Column
	SET columnId = 281, tableId = 10, name = "cd11",
	...
	INSERT INTO md_Column
	SET columnId = 282, tableId = 10, name = "cd21",
	...
	INSERT INTO md_Column
	SET columnId = 283, tableId = 10, name = "cd12",
	...
	INSERT INTO md_Column
	SET columnId = 284, tableId = 10, name = "cd22",
	...
	INSERT INTO md_Column
	SET columnId = 285, tableId = 10, name = "taiObs",
	...
	INSERT INTO md_Column
	SET columnId = 286, tableId = 10, name = "darkTime",
	...
	INSERT INTO md_Column
	SET columnId = 287, tableId = 10, name = "zd",
...
SET tableId = 11, name = "Raw_Ccd_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 288, tableId = 11, name = "rawCcdExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 289, tableId = 11, name = "rawFpaExposureId",
...
SET tableId = 12, name = "Raw_Fpa_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 290, tableId = 12, name = "rawFpaExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 291, tableId = 12, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 292, tableId = 12, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 293, tableId = 12, name = "filterId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 294, tableId = 12, name = "equinox",
	...
	INSERT INTO md_Column
	SET columnId = 295, tableId = 12, name = "dateObs",
	...
	INSERT INTO md_Column
	SET columnId = 296, tableId = 12, name = "mjdObs",
	...
	INSERT INTO md_Column
	SET columnId = 297, tableId = 12, name = "expTime",
	...
	INSERT INTO md_Column
	SET columnId = 298, tableId = 12, name = "airmass",
...
SET tableId = 13, name = "Science_Amp_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 299, tableId = 13, name = "scienceAmpExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 300, tableId = 13, name = "scienceCcdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 301, tableId = 13, name = "scienceFpaExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 302, tableId = 13, name = "rawAmpExposureId",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 303, tableId = 13, name = "ampId",
	...
	INSERT INTO md_Column
	SET columnId = 304, tableId = 13, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 305, tableId = 13, name = "equinox",
		description = "Equinox of World Coordinate System.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 7;
	...
	INSERT INTO md_Column
	SET columnId = 306, tableId = 13, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 307, tableId = 13, name = "ctype1",
		description = "Coordinate projection type, axis 1.",
		type = "VARCHAR(20)",
		notNull = 0,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 308, tableId = 13, name = "ctype2",
		description = "Coordinate projection type, axis 2.",
		type = "VARCHAR(20)",
		notNull = 0,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 309, tableId = 13, name = "crpix1",
		description = "Coordinate reference pixel, axis 1.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 310, tableId = 13, name = "crpix2",
		description = "Coordinate reference pixel, axis 2.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 12;
	...
	INSERT INTO md_Column
	SET columnId = 311, tableId = 13, name = "crval1",
		description = "Coordinate value 1 @reference pixel.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 312, tableId = 13, name = "crval2",
		description = "Coordinate value 2 @reference pixel.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 313, tableId = 13, name = "cd1_1",
		description = "First derivative of coordinate 1 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 314, tableId = 13, name = "cd2_1",
		description = "First derivative of coordinate 2 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 16;
	...
	INSERT INTO md_Column
	SET columnId = 315, tableId = 13, name = "cd1_2",
		description = "First derivative of coordinate 1 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 17;
	...
	INSERT INTO md_Column
	SET columnId = 316, tableId = 13, name = "cd2_2",
		description = "First derivative of coordinate 2 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 18;
	...
	INSERT INTO md_Column
	SET columnId = 317, tableId = 13, name = "dateObs",
		description = "Date/Time of observation start (UTC).",
		type = "TIMESTAMP",
		notNull = 0,
		defaultValue = "0",
	...
	INSERT INTO md_Column
	SET columnId = 318, tableId = 13, name = "expTime",
		description = "Duration of exposure.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 20;
	...
	INSERT INTO md_Column
	SET columnId = 319, tableId = 13, name = "ccdSize",
	...
	INSERT INTO md_Column
	SET columnId = 320, tableId = 13, name = "photoFlam",
	...
	INSERT INTO md_Column
	SET columnId = 321, tableId = 13, name = "photoZP",
	...
	INSERT INTO md_Column
	SET columnId = 322, tableId = 13, name = "nCombine",
	...
	INSERT INTO md_Column
	SET columnId = 323, tableId = 13, name = "taiMjd",
	...
	INSERT INTO md_Column
	SET columnId = 324, tableId = 13, name = "binX",
	...
	INSERT INTO md_Column
	SET columnId = 325, tableId = 13, name = "binY",
	...
	INSERT INTO md_Column
	SET columnId = 326, tableId = 13, name = "readNoise",
	...
	INSERT INTO md_Column
	SET columnId = 327, tableId = 13, name = "saturationLimit",
	...
	INSERT INTO md_Column
	SET columnId = 328, tableId = 13, name = "dataSection",
	...
	INSERT INTO md_Column
	SET columnId = 329, tableId = 13, name = "gain",
...
SET tableId = 14, name = "Science_Ccd_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 330, tableId = 14, name = "scienceCcdExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 331, tableId = 14, name = "scienceFpaExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 332, tableId = 14, name = "rawCcdExposureId",
...
SET tableId = 15, name = "Science_Fpa_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 333, tableId = 15, name = "scienceFpaExposureId",
		description = "Primary key (unique identifier).&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 16, name = "Source",
	...
	INSERT INTO md_Column
	SET columnId = 334, tableId = 16, name = "sourceId",
		description = "Unique id.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 335, tableId = 16, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 336, tableId = 16, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 337, tableId = 16, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 338, tableId = 16, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 339, tableId = 16, name = "xAstrom",
		description = "x position computed by a centroiding algorithm for the purposes of astrometry using Dave Monet's algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 340, tableId = 16, name = "xAstromSigma",
		description = "Uncertainty of xAstrom.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 341, tableId = 16, name = "yAstrom",
		description = "y position computed by a centroiding algorithm for the purposes of astrometry using Dave Monet's algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 342, tableId = 16, name = "yAstromSigma",
		description = "Uncertainty of yAstrom.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 343, tableId = 16, name = "xyAstromCov",
		description = "Covariance between the xAstrom and the yAstrom.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 344, tableId = 16, name = "xOther",
		description = "x position computed by a centroiding algorithm for the purposes of astrometry using &quot;other&quot; centroiding algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		unit = "degree",
	...
	INSERT INTO md_Column
	SET columnId = 345, tableId = 16, name = "xOtherSigma",
		description = "Uncertainty of xOther.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 12;
	...
	INSERT INTO md_Column
	SET columnId = 346, tableId = 16, name = "yOther",
		description = "y position computed by a centroiding algorithm for the purposes of astrometry using &quot;other&quot; centroiding algorithm.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 347, tableId = 16, name = "yOtherSigma",
		description = "Uncertainty of yOther.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 348, tableId = 16, name = "xyOtherCov",
		description = "Covariance between the xOther and yOther.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 349, tableId = 16, name = "sky",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 16;

	INSERT INTO md_Column
	SET columnId = 350, tableId = 16, name = "skySigma",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 17;

	INSERT INTO md_Column
	SET columnId = 351, tableId = 16, name = "psfLnL",
		description = "ln(likelihood) of being a PSF.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 18;
	...
	INSERT INTO md_Column
	SET columnId = 352, tableId = 16, name = "psfFlux",
		description = "PSF flux of the object.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 19;
	...
	INSERT INTO md_Column
	SET columnId = 353, tableId = 16, name = "psfFluxSigma",
		description = "Uncertainty of psfFlux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 20;
	...
	INSERT INTO md_Column
	SET columnId = 354, tableId = 16, name = "apFlux",
		description = "Aperture flux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 21;
	...
	INSERT INTO md_Column
	SET columnId = 355, tableId = 16, name = "apFluxSigma",
		description = "Uncertainty of apFlux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 22;
	...
	INSERT INTO md_Column
	SET columnId = 356, tableId = 16, name = "modelFlux",
		description = "Adaptive 2D gauss model flux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 23;
	...
	INSERT INTO md_Column
	SET columnId = 357, tableId = 16, name = "modelFluxSigma",
		description = "Uncertainly of modelFlux.&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 24;
	...
	INSERT INTO md_Column
	SET columnId = 358, tableId = 16, name = "i",
		description = "Flux in the i band.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 25;
	...
	INSERT INTO md_Column
	SET columnId = 359, tableId = 16, name = "iSigma",
		description = "Uncertainty of i.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 26;
	...
	INSERT INTO md_Column
	SET columnId = 360, tableId = 16, name = "momentIx",
		description = "Adaptive first moment. The moments are primarily for the moving objects, but should carry some information about defects, cosmics, etc. too.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 27;
	...
	INSERT INTO md_Column
	SET columnId = 361, tableId = 16, name = "momentIxSigma",
		description = "Uncertainty of momentIx.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;
	...
	INSERT INTO md_Column
	SET columnId = 362, tableId = 16, name = "momentIy",
		description = "Adaptive first moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 29;
	...
	INSERT INTO md_Column
	SET columnId = 363, tableId = 16, name = "momentIySigma",
		description = "Uncertainty of momentIy.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 30;
	...
	INSERT INTO md_Column
	SET columnId = 364, tableId = 16, name = "momentIxx",
		description = "Adaptive second moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 31;
	...
	INSERT INTO md_Column
	SET columnId = 365, tableId = 16, name = "momentIxxSigma",
		description = "Uncertainty of momentIxx: sqrt(covariance(x, x)).&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 32;
	...
	INSERT INTO md_Column
	SET columnId = 366, tableId = 16, name = "momentIyy",
		description = "Adaptive second moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 33;
	...
	INSERT INTO md_Column
	SET columnId = 367, tableId = 16, name = "momentIyySigma",
		description = "Uncertainty of momentIyy: sqrt(covariance(y, y)).&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 34;
	...
	INSERT INTO md_Column
	SET columnId = 368, tableId = 16, name = "momentIxy",
		description = "Adaptive second moment.&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 35;
	...
	INSERT INTO md_Column
	SET columnId = 369, tableId = 16, name = "momentIxySigma",
		description = "Uncertainty of momentIxy: sqrt(covariance(x, y)).&#xA;",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 36;
	...
	INSERT INTO md_Column
	SET columnId = 370, tableId = 16, name = "tiaObs",
		description = "TAI-OBS = UTC + offset, offset = 32 s from  1/1/1999 to 1/1/2006&#xA;",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 37;
	...
	INSERT INTO md_Column
	SET columnId = 371, tableId = 16, name = "flags",
		description = "Flags.&#xA;",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 38;
...
SET tableId = 17, name = "Visit",
	...
	INSERT INTO md_Column
	SET columnId = 372, tableId = 17, name = "visitId",
	...
	INSERT INTO md_Column
	SET columnId = 373, tableId = 17, name = "exposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 18, name = "_MovingObjectToType",
	...
	INSERT INTO md_Column
	SET columnId = 374, tableId = 18, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 375, tableId = 18, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 376, tableId = 18, name = "probability",
...
SET tableId = 19, name = "_ObjectToType",
	...
	INSERT INTO md_Column
	SET columnId = 377, tableId = 19, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 378, tableId = 19, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 379, tableId = 19, name = "probability",
...
SET tableId = 20, name = "_Raw_Fpa_ExposureToVisit",
	...
	INSERT INTO md_Column
	SET columnId = 380, tableId = 20, name = "visitId",
	...
	INSERT INTO md_Column
	SET columnId = 381, tableId = 20, name = "exposureId",
...
SET tableId = 21, name = "_Science_Fpa_ExposureToTemplateImage",
	...
	INSERT INTO md_Column
	SET columnId = 382, tableId = 21, name = "scienceFpaExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 383, tableId = 21, name = "templateImageId",
...
SET tableId = 22, name = "_mops_Config",
	...
	INSERT INTO md_Column
	SET columnId = 384, tableId = 22, name = "configId",
	...
	INSERT INTO md_Column
	SET columnId = 385, tableId = 22, name = "configText",
...
SET tableId = 23, name = "_mops_EonQueue",
	...
	INSERT INTO md_Column
	SET columnId = 386, tableId = 23, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 387, tableId = 23, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 388, tableId = 23, name = "insertTime",
	...
	INSERT INTO md_Column
	SET columnId = 389, tableId = 23, name = "status",
...
SET tableId = 24, name = "_mops_MoidQueue",
	...
	INSERT INTO md_Column
	SET columnId = 390, tableId = 24, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 391, tableId = 24, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 392, tableId = 24, name = "eventId",
		description = "Referring history event causing insertion",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 393, tableId = 24, name = "insertTime",
		description = "Wall clock time object was queued",
		type = "TIMESTAMP",
		notNull = 1,
...
SET tableId = 25, name = "_tmpl_Id",
	...
	INSERT INTO md_Column
	SET columnId = 394, tableId = 25, name = "id",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 26, name = "_tmpl_IdPair",
	...
	INSERT INTO md_Column
	SET columnId = 395, tableId = 26, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 396, tableId = 26, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 27, name = "_tmpl_MatchPair",
	...
	INSERT INTO md_Column
	SET columnId = 397, tableId = 27, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 398, tableId = 27, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 399, tableId = 27, name = "distance",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 3;
...
SET tableId = 28, name = "_tmpl_mops_Ephemeris",
	...
	INSERT INTO md_Column
	SET columnId = 400, tableId = 28, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 401, tableId = 28, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 402, tableId = 28, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 403, tableId = 28, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 404, tableId = 28, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 405, tableId = 28, name = "smia",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 406, tableId = 28, name = "smaa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 407, tableId = 28, name = "pa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 408, tableId = 28, name = "mag",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 9;
...
SET tableId = 29, name = "_tmpl_mops_Prediction",
	...
	INSERT INTO md_Column
	SET columnId = 409, tableId = 29, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 410, tableId = 29, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 411, tableId = 29, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 412, tableId = 29, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 413, tableId = 29, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 414, tableId = 29, name = "smia",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 415, tableId = 29, name = "smaa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 416, tableId = 29, name = "pa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 417, tableId = 29, name = "mag",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 418, tableId = 29, name = "magErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
...
SET tableId = 30, name = "mops_Event";
	...
	INSERT INTO md_Column
	SET columnId = 419, tableId = 30, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 420, tableId = 30, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 421, tableId = 30, name = "eventType",
	...
	INSERT INTO md_Column
	SET columnId = 422, tableId = 30, name = "eventTime",
	...
	INSERT INTO md_Column
	SET columnId = 423, tableId = 30, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 424, tableId = 30, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 425, tableId = 30, name = "orbitCode",
	...
	INSERT INTO md_Column
	SET columnId = 426, tableId = 30, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 427, tableId = 30, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 428, tableId = 30, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 429, tableId = 30, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 430, tableId = 30, name = "ssmId",
...
SET tableId = 31, name = "mops_Event_OrbitDerivation",
	...
	INSERT INTO md_Column
	SET columnId = 431, tableId = 31, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 432, tableId = 31, name = "trackletId",
...
SET tableId = 32, name = "mops_Event_OrbitIdentification",
	...
	INSERT INTO md_Column
	SET columnId = 433, tableId = 32, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 434, tableId = 32, name = "childObjectId",
...
SET tableId = 33, name = "mops_Event_TrackletAttribution",
	...
	INSERT INTO md_Column
	SET columnId = 435, tableId = 33, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 436, tableId = 33, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 437, tableId = 33, name = "ephemerisDistance",
	...
	INSERT INTO md_Column
	SET columnId = 438, tableId = 33, name = "ephemerisUncertainty",
...
SET tableId = 34, name = "mops_Event_TrackletPrecovery",
	...
	INSERT INTO md_Column
	SET columnId = 439, tableId = 34, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 440, tableId = 34, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 441, tableId = 34, name = "ephemerisDistance",
		description = "Predicted position minus actual, arcsecs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 442, tableId = 34, name = "ephemerisUncertainty",
		description = "Predicted error ellipse semi-major axis, arcsecs",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 35, name = "mops_Event_TrackletRemoval",
	...
	INSERT INTO md_Column
	SET columnId = 443, tableId = 35, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 444, tableId = 35, name = "trackletId",
...
SET tableId = 36, name = "mops_MovingObjectToTracklet",
	...
	INSERT INTO md_Column
	SET columnId = 445, tableId = 36, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 446, tableId = 36, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 37, name = "mops_SSM",
	...
	INSERT INTO md_Column
	SET columnId = 447, tableId = 37, name = "ssmId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 448, tableId = 37, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 449, tableId = 37, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 450, tableId = 37, name = "e",
		description = "eccentricity e (dimensionless)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 451, tableId = 37, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 452, tableId = 37, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 453, tableId = 37, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 454, tableId = 37, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 455, tableId = 37, name = "epoch",
		description = "epoch of osculating elements, MJD (UTC)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 456, tableId = 37, name = "h_v",
		description = "Absolute magnitude",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 457, tableId = 37, name = "h_ss",
		description = "??",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 458, tableId = 37, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 459, tableId = 37, name = "albedo",
		description = "Albedo, dimensionless",
		type = "DOUBLE",
		notNull = 0,
		unit = "-",
	...
	INSERT INTO md_Column
	SET columnId = 460, tableId = 37, name = "ssmObjectName",
...
SET tableId = 38, name = "mops_SSMDesc",
	...
	INSERT INTO md_Column
	SET columnId = 461, tableId = 38, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 462, tableId = 38, name = "prefix",
	...
	INSERT INTO md_Column
	SET columnId = 463, tableId = 38, name = "description",
...
SET tableId = 39, name = "mops_TrackToTracklet";
	...
	INSERT INTO md_Column
	SET columnId = 464, tableId = 39, name = "trackId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 465, tableId = 39, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 40, name = "mops_Tracklet";
	...
	INSERT INTO md_Column
	SET columnId = 466, tableId = 40, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 467, tableId = 40, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 468, tableId = 40, name = "procHistoryId",
		description = "Pointer to processing history (prv_ProcHistory)",
		type = "INT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 469, tableId = 40, name = "ssmId",
		description = "Matching SSM ID for clean classifications",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 470, tableId = 40, name = "velRa",
	...
	INSERT INTO md_Column
	SET columnId = 471, tableId = 40, name = "velRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 472, tableId = 40, name = "velDecl",
	...
	INSERT INTO md_Column
	SET columnId = 473, tableId = 40, name = "velDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 474, tableId = 40, name = "velTot",
	...
	INSERT INTO md_Column
	SET columnId = 475, tableId = 40, name = "accRa",
	...
	INSERT INTO md_Column
	SET columnId = 476, tableId = 40, name = "accRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 477, tableId = 40, name = "accDecl",
	...
	INSERT INTO md_Column
	SET columnId = 478, tableId = 40, name = "accDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 479, tableId = 40, name = "extEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 480, tableId = 40, name = "extRa",
	...
	INSERT INTO md_Column
	SET columnId = 481, tableId = 40, name = "extRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 482, tableId = 40, name = "extDecl",
	...
	INSERT INTO md_Column
	SET columnId = 483, tableId = 40, name = "extDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 484, tableId = 40, name = "extMag",
	...
	INSERT INTO md_Column
	SET columnId = 485, tableId = 40, name = "extMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 486, tableId = 40, name = "probability",
	...
	INSERT INTO md_Column
	SET columnId = 487, tableId = 40, name = "status",
	...
	INSERT INTO md_Column
	SET columnId = 488, tableId = 40, name = "classification",
...
SET tableId = 41, name = "mops_TrackletToDiaSource",
	...
	INSERT INTO md_Column
	SET columnId = 489, tableId = 41, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 490, tableId = 41, name = "diaSourceId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 42, name = "prv_Filter",
	...
	INSERT INTO md_Column
	SET columnId = 491, tableId = 42, name = "filterId",
		description = "Unique id.",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 492, tableId = 42, name = "focalPlaneId",
	...
	INSERT INTO md_Column
	SET columnId = 493, tableId = 42, name = "name",
	...
	INSERT INTO md_Column
	SET columnId = 494, tableId = 42, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 495, tableId = 42, name = "clam",
	...
	INSERT INTO md_Column
	SET columnId = 496, tableId = 42, name = "bw",
...
SET tableId = 43, name = "prv_PolicyFile";
	...
	INSERT INTO md_Column
	SET columnId = 497, tableId = 43, name = "policyFileId",
	...
	INSERT INTO md_Column
	SET columnId = 498, tableId = 43, name = "pathName",
	...
	INSERT INTO md_Column
	SET columnId = 499, tableId = 43, name = "hashValue",
	...
	INSERT INTO md_Column
	SET columnId = 500, tableId = 43, name = "modifiedDate",
...
SET tableId = 44, name = "prv_PolicyKey";
	...
	INSERT INTO md_Column
	SET columnId = 501, tableId = 44, name = "policyKeyId",
	...
	INSERT INTO md_Column
	SET columnId = 502, tableId = 44, name = "policyFileId",
	...
	INSERT INTO md_Column
	SET columnId = 503, tableId = 44, name = "keyName",
	...
	INSERT INTO md_Column
	SET columnId = 504, tableId = 44, name = "keyType",
...
SET tableId = 45, name = "prv_Run";
	...
	INSERT INTO md_Column
	SET columnId = 505, tableId = 45, name = "offset",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 506, tableId = 45, name = "runId",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 507, tableId = 45, name = "hostName",
		type = "VARCHAR(64)",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 508, tableId = 45, name = "processId",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 46, name = "prv_SoftwarePackage";
	...
	INSERT INTO md_Column
	SET columnId = 509, tableId = 46, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 510, tableId = 46, name = "packageName",
		type = "VARCHAR(64)",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 47, name = "prv_cnf_PolicyKey";
	...
	INSERT INTO md_Column
	SET columnId = 511, tableId = 47, name = "policyKeyId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 512, tableId = 47, name = "value",
		type = "TEXT",
		notNull = 0,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 513, tableId = 47, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 514, tableId = 47, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 48, name = "prv_cnf_SoftwarePackage";
	...
	INSERT INTO md_Column
	SET columnId = 515, tableId = 48, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 516, tableId = 48, name = "version",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 517, tableId = 48, name = "directory",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 518, tableId = 48, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 519, tableId = 48, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 5;
...
SET tableId = 49, name = "sdqa_ImageStatus",
	...
	INSERT INTO md_Column
	SET columnId = 520, tableId = 49, name = "sdqa_imageStatusId",
	...
	INSERT INTO md_Column
	SET columnId = 521, tableId = 49, name = "statusName",
	...
	INSERT INTO md_Column
	SET columnId = 522, tableId = 49, name = "definition",
...
SET tableId = 50, name = "sdqa_Metric",
	...
	INSERT INTO md_Column
	SET columnId = 523, tableId = 50, name = "sdqa_metricId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 524, tableId = 50, name = "metricName",
	...
	INSERT INTO md_Column
	SET columnId = 525, tableId = 50, name = "physicalUnits",
	...
	INSERT INTO md_Column
	SET columnId = 526, tableId = 50, name = "dataType",
	...
	INSERT INTO md_Column
	SET columnId = 527, tableId = 50, name = "definition",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 5;
...
SET tableId = 51, name = "sdqa_Rating_ForScienceAmpExposure",
	...
	INSERT INTO md_Column
	SET columnId = 528, tableId = 51, name = "sdqa_ratingId",
	...
	INSERT INTO md_Column
	SET columnId = 529, tableId = 51, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 530, tableId = 51, name = "sdqa_thresholdId",
	...
	INSERT INTO md_Column
	SET columnId = 531, tableId = 51, name = "ampExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 532, tableId = 51, name = "metricValue",
	...
	INSERT INTO md_Column
	SET columnId = 533, tableId = 51, name = "metricSigma",
...
SET tableId = 52, name = "sdqa_Rating_ForScienceCcdExposure",
	...
	INSERT INTO md_Column
	SET columnId = 534, tableId = 52, name = "sdqa_ratingId",
		description = "Primary key. Auto-increment is used, we define a composite unique key, so potential duplicates will be captured.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 535, tableId = 52, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 536, tableId = 52, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 537, tableId = 52, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 538, tableId = 52, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 539, tableId = 52, name = "metricSigma",
		description = "Uncertainty of the value of this metric.&#xA;",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
SET tableId = 53, name = "sdqa_Rating_ForScienceFpaExposure",
	...
	INSERT INTO md_Column
	SET columnId = 540, tableId = 53, name = "sdqa_ratingId",
		description = "Primary key. Auto-increment is used, we define a composite unique key, so potential duplicates will be captured.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 541, tableId = 53, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 542, tableId = 53, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 543, tableId = 53, name = "exposureId",
	...
	INSERT INTO md_Column
	SET columnId = 544, tableId = 53, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 545, tableId = 53, name = "metricSigma",
		description = "Uncertainty of the value of this metric.&#xA;",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
SET tableId = 54, name = "sdqa_Threshold",
	...
	INSERT INTO md_Column
	SET columnId = 546, tableId = 54, name = "sdqa_thresholdId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 547, tableId = 54, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 548, tableId = 54, name = "upperThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 549, tableId = 54, name = "lowerThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 550, tableId = 54, name = "createdDate",
