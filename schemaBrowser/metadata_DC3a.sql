...
SET tableId = 7, name = "Raw_Amp_Exposure";
	...
	SET columnId = 194, tableId = 7, name = "rawCCDExposureId",
		description = "Pointer to Raw_CCD_Exposure containing this raw amp exposure.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 195, tableId = 7, name = "rawFPAExposureId",
		description = "Pointer to Raw_FPA_Exposure containing this raw amp exposure.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 196, tableId = 7, name = "ampId",
	...
	INSERT INTO md_Column
	SET columnId = 197, tableId = 7, name = "radecSys",
	...
	INSERT INTO md_Column
	SET columnId = 198, tableId = 7, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 199, tableId = 7, name = "ctype1",
	...
	INSERT INTO md_Column
	SET columnId = 200, tableId = 7, name = "ctype2",
	...
	INSERT INTO md_Column
	SET columnId = 201, tableId = 7, name = "crpix1",
	...
	INSERT INTO md_Column
	SET columnId = 202, tableId = 7, name = "crpix2",
	...
	INSERT INTO md_Column
	SET columnId = 203, tableId = 7, name = "crval1",
	...
	INSERT INTO md_Column
	SET columnId = 204, tableId = 7, name = "crval2",
	...
	INSERT INTO md_Column
	SET columnId = 205, tableId = 7, name = "cd11",
	...
	INSERT INTO md_Column
	SET columnId = 206, tableId = 7, name = "cd21",
	...
	INSERT INTO md_Column
	SET columnId = 207, tableId = 7, name = "cd12",
	...
	INSERT INTO md_Column
	SET columnId = 208, tableId = 7, name = "cd22",
	...
	INSERT INTO md_Column
	SET columnId = 209, tableId = 7, name = "taiObs",
	...
	INSERT INTO md_Column
	SET columnId = 210, tableId = 7, name = "darkTime",
	...
	INSERT INTO md_Column
	SET columnId = 211, tableId = 7, name = "zd",
...
SET tableId = 8, name = "Raw_CCD_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 212, tableId = 8, name = "rawCCDExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 213, tableId = 8, name = "rawFPAExposureId",
...
SET tableId = 9, name = "Raw_FPA_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 214, tableId = 9, name = "rawFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 215, tableId = 9, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 216, tableId = 9, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 217, tableId = 9, name = "filterId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 218, tableId = 9, name = "equinox",
	...
	INSERT INTO md_Column
	SET columnId = 219, tableId = 9, name = "dateObs",
	...
	INSERT INTO md_Column
	SET columnId = 220, tableId = 9, name = "mjdObs",
	...
	INSERT INTO md_Column
	SET columnId = 221, tableId = 9, name = "expTime",
	...
	INSERT INTO md_Column
	SET columnId = 222, tableId = 9, name = "airmass",
...
SET tableId = 10, name = "Science_Amp_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 223, tableId = 10, name = "scienceAmpExposureId",
		description = "Primary key.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 224, tableId = 10, name = "scienceCCDExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 225, tableId = 10, name = "scienceFPAExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 226, tableId = 10, name = "rawAmpExposureId",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 227, tableId = 10, name = "ampId",
	...
	INSERT INTO md_Column
	SET columnId = 228, tableId = 10, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 229, tableId = 10, name = "equinox",
		description = "Equinox of World Coordinate System.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 7;
	...
	INSERT INTO md_Column
	SET columnId = 230, tableId = 10, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 231, tableId = 10, name = "ctype1",
		description = "Coordinate projection type, axis 1.",
		type = "VARCHAR(20)",
		notNull = 0,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 232, tableId = 10, name = "ctype2",
		description = "Coordinate projection type, axis 2.",
		type = "VARCHAR(20)",
		notNull = 0,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 233, tableId = 10, name = "crpix1",
		description = "Coordinate reference pixel, axis 1.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 234, tableId = 10, name = "crpix2",
		description = "Coordinate reference pixel, axis 2.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 12;
	...
	INSERT INTO md_Column
	SET columnId = 235, tableId = 10, name = "crval1",
		description = "Coordinate value 1 @reference pixel.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 236, tableId = 10, name = "crval2",
		description = "Coordinate value 2 @reference pixel.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 237, tableId = 10, name = "cd1_1",
		description = "First derivative of coordinate 1 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 238, tableId = 10, name = "cd2_1",
		description = "First derivative of coordinate 2 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 16;
	...
	INSERT INTO md_Column
	SET columnId = 239, tableId = 10, name = "cd1_2",
		description = "First derivative of coordinate 1 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 17;
	...
	INSERT INTO md_Column
	SET columnId = 240, tableId = 10, name = "cd2_2",
		description = "First derivative of coordinate 2 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 18;
	...
	INSERT INTO md_Column
	SET columnId = 241, tableId = 10, name = "dateObs",
		description = "Date/Time of observation start (UTC).",
		type = "TIMESTAMP",
		notNull = 0,
		defaultValue = "0",
	...
	INSERT INTO md_Column
	SET columnId = 242, tableId = 10, name = "expTime",
		description = "Duration of exposure.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 20;
	...
	INSERT INTO md_Column
	SET columnId = 243, tableId = 10, name = "ccdSize",
	...
	INSERT INTO md_Column
	SET columnId = 244, tableId = 10, name = "photoFlam",
	...
	INSERT INTO md_Column
	SET columnId = 245, tableId = 10, name = "photoZP",
	...
	INSERT INTO md_Column
	SET columnId = 246, tableId = 10, name = "nCombine",
	...
	INSERT INTO md_Column
	SET columnId = 247, tableId = 10, name = "taiMjd",
	...
	INSERT INTO md_Column
	SET columnId = 248, tableId = 10, name = "binX",
	...
	INSERT INTO md_Column
	SET columnId = 249, tableId = 10, name = "binY",
	...
	INSERT INTO md_Column
	SET columnId = 250, tableId = 10, name = "readNoise",
	...
	INSERT INTO md_Column
	SET columnId = 251, tableId = 10, name = "saturationLimit",
	...
	INSERT INTO md_Column
	SET columnId = 252, tableId = 10, name = "dataSection",
	...
	INSERT INTO md_Column
	SET columnId = 253, tableId = 10, name = "gain",
...
SET tableId = 11, name = "Science_CCD_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 254, tableId = 11, name = "scienceCCDExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 255, tableId = 11, name = "scienceFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 256, tableId = 11, name = "rawCCDExposureId",
...
SET tableId = 12, name = "Science_FPA_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 257, tableId = 12, name = "scienceFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 13, name = "Visit",
	...
	INSERT INTO md_Column
	SET columnId = 258, tableId = 13, name = "visitId",
		description = "Unique id.",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 259, tableId = 13, name = "exposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 14, name = "WCSSource",
	...
	INSERT INTO md_Column
	SET columnId = 260, tableId = 14, name = "wcsSourceId",
		description = "Unique id.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 261, tableId = 14, name = "ampExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 262, tableId = 14, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 263, tableId = 14, name = "wcsObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 264, tableId = 14, name = "wcsObjectRa",
	...
	INSERT INTO md_Column
	SET columnId = 265, tableId = 14, name = "wcsObjectRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 266, tableId = 14, name = "wcsObjectDecl",
	...
	INSERT INTO md_Column
	SET columnId = 267, tableId = 14, name = "wcsObjectDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 268, tableId = 14, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 269, tableId = 14, name = "raErr",
	...
	INSERT INTO md_Column
	SET columnId = 270, tableId = 14, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 271, tableId = 14, name = "declErr",
	...
	INSERT INTO md_Column
	SET columnId = 272, tableId = 14, name = "xFlux",
	...
	INSERT INTO md_Column
	SET columnId = 273, tableId = 14, name = "xFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 274, tableId = 14, name = "yFlux",
	...
	INSERT INTO md_Column
	SET columnId = 275, tableId = 14, name = "yFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 276, tableId = 14, name = "raFlux",
	...
	INSERT INTO md_Column
	SET columnId = 277, tableId = 14, name = "raFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 278, tableId = 14, name = "declFlux",
	...
	INSERT INTO md_Column
	SET columnId = 279, tableId = 14, name = "declFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 280, tableId = 14, name = "xPeak",
	...
	INSERT INTO md_Column
	SET columnId = 281, tableId = 14, name = "yPeak",
	...
	INSERT INTO md_Column
	SET columnId = 282, tableId = 14, name = "raPeak",
	...
	INSERT INTO md_Column
	SET columnId = 283, tableId = 14, name = "declPeak",
	...
	INSERT INTO md_Column
	SET columnId = 284, tableId = 14, name = "xAstrom",
		description = "The position (x) measured for purposes of astrometry.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 25;
	...
	INSERT INTO md_Column
	SET columnId = 285, tableId = 14, name = "xAstromErr",
		description = "Uncertainty for xAstrom",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 26;
	...
	INSERT INTO md_Column
	SET columnId = 286, tableId = 14, name = "yAstrom",
		description = "The position (y) measured for purposes of astrometry.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 27;
	...
	INSERT INTO md_Column
	SET columnId = 287, tableId = 14, name = "yAstromErr",
		description = "Uncertainty for yAstrom",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;
	...
	INSERT INTO md_Column
	SET columnId = 288, tableId = 14, name = "raAstrom",
	...
	INSERT INTO md_Column
	SET columnId = 289, tableId = 14, name = "raAstromErr",
	...
	INSERT INTO md_Column
	SET columnId = 290, tableId = 14, name = "declAstrom",
	...
	INSERT INTO md_Column
	SET columnId = 291, tableId = 14, name = "declAstromErr",
	...
	INSERT INTO md_Column
	SET columnId = 292, tableId = 14, name = "psfFlux",
		description = "PSF flux of the object.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 33;
	...
	INSERT INTO md_Column
	SET columnId = 293, tableId = 14, name = "psfFluxErr",
		description = "Uncertainty of psfFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 34;
	...
	INSERT INTO md_Column
	SET columnId = 294, tableId = 14, name = "apFlux",
		description = "Aperture flux.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 35;
	...
	INSERT INTO md_Column
	SET columnId = 295, tableId = 14, name = "apFluxErr",
		description = "Uncertainty of apFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 36;
	...
	INSERT INTO md_Column
	SET columnId = 296, tableId = 14, name = "modelFlux",
	...
	INSERT INTO md_Column
	SET columnId = 297, tableId = 14, name = "modelFluxErr",
		description = "Uncertainly of modelFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 38;
	...
	INSERT INTO md_Column
	SET columnId = 298, tableId = 14, name = "petroFlux",
	...
	INSERT INTO md_Column
	SET columnId = 299, tableId = 14, name = "petroFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 300, tableId = 14, name = "instFlux",
		description = "Instrumental flux.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 41;
	...
	INSERT INTO md_Column
	SET columnId = 301, tableId = 14, name = "instFluxErr",
		description = "Uncertainty of instFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 42;
	...
	INSERT INTO md_Column
	SET columnId = 302, tableId = 14, name = "nonGrayCorrFlux",
	...
	INSERT INTO md_Column
	SET columnId = 303, tableId = 14, name = "nonGrayCorrFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 304, tableId = 14, name = "atmCorrFlux",
	...
	INSERT INTO md_Column
	SET columnId = 305, tableId = 14, name = "atmCorrFluxErr",
	...
	INSERT INTO md_Column
	SET columnId = 306, tableId = 14, name = "apDia",
		description = "Diameter of aperture (pixels)",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 47;
	...
	INSERT INTO md_Column
	SET columnId = 307, tableId = 14, name = "Ixx",
		description = "Adaptive second moment.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 48;
	...
	INSERT INTO md_Column
	SET columnId = 308, tableId = 14, name = "IxxErr",
		description = "Uncertainty of Ixx: sqrt(covariance(x, x))",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 49;
	...
	INSERT INTO md_Column
	SET columnId = 309, tableId = 14, name = "Iyy",
		description = "Adaptive second moment.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 50;
	...
	INSERT INTO md_Column
	SET columnId = 310, tableId = 14, name = "IyyErr",
		description = "Uncertainty of Iyy: sqrt(covariance(y, y))",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 51;
	...
	INSERT INTO md_Column
	SET columnId = 311, tableId = 14, name = "Ixy",
		description = "Adaptive second moment.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 52;
	...
	INSERT INTO md_Column
	SET columnId = 312, tableId = 14, name = "IxyErr",
		description = "Uncertainty of Ixy: sign(covariance(x, y))*sqrt(|covariance(x, y)|)",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 53;
	...
	INSERT INTO md_Column
	SET columnId = 313, tableId = 14, name = "snr",
	...
	INSERT INTO md_Column
	SET columnId = 314, tableId = 14, name = "chi2",
		description = "Chi-square value for the PSF fit",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 55;
	...
	INSERT INTO md_Column
	SET columnId = 315, tableId = 14, name = "sky",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 56;

	INSERT INTO md_Column
	SET columnId = 316, tableId = 14, name = "skyErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 57;

	INSERT INTO md_Column
	SET columnId = 317, tableId = 14, name = "flag",
...
SET tableId = 15, name = "_MovingObjectToType",
	...
	INSERT INTO md_Column
	SET columnId = 318, tableId = 15, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 319, tableId = 15, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 320, tableId = 15, name = "probability",
...
SET tableId = 16, name = "_ObjectToType",
	...
	INSERT INTO md_Column
	SET columnId = 321, tableId = 16, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 322, tableId = 16, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 323, tableId = 16, name = "probability",
...
SET tableId = 17, name = "_Raw_FPA_ExposureToVisit",
	...
	INSERT INTO md_Column
	SET columnId = 324, tableId = 17, name = "visitId",
	...
	INSERT INTO md_Column
	SET columnId = 325, tableId = 17, name = "exposureId",
...
SET tableId = 18, name = "_Science_FPA_ExposureToTemplateImage",
	...
	INSERT INTO md_Column
	SET columnId = 326, tableId = 18, name = "scienceFPAExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 327, tableId = 18, name = "templateImageId",
...
SET tableId = 19, name = "_mops_Config",
	...
	INSERT INTO md_Column
	SET columnId = 328, tableId = 19, name = "configId",
	...
	INSERT INTO md_Column
	SET columnId = 329, tableId = 19, name = "configText",
...
SET tableId = 20, name = "_mops_EonQueue",
	...
	INSERT INTO md_Column
	SET columnId = 330, tableId = 20, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 331, tableId = 20, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 332, tableId = 20, name = "insertTime",
	...
	INSERT INTO md_Column
	SET columnId = 333, tableId = 20, name = "status",
...
SET tableId = 21, name = "_mops_MoidQueue",
	...
	INSERT INTO md_Column
	SET columnId = 334, tableId = 21, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 335, tableId = 21, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 336, tableId = 21, name = "eventId",
		description = "Referring history event causing insertion",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 337, tableId = 21, name = "insertTime",
		description = "Wall clock time object was queued",
		type = "TIMESTAMP",
		notNull = 1,
...
SET tableId = 22, name = "_tmpl_Id",
	...
	INSERT INTO md_Column
	SET columnId = 338, tableId = 22, name = "id",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 23, name = "_tmpl_IdPair",
	...
	INSERT INTO md_Column
	SET columnId = 339, tableId = 23, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 340, tableId = 23, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 24, name = "_tmpl_MatchPair",
	...
	INSERT INTO md_Column
	SET columnId = 341, tableId = 24, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 342, tableId = 24, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 343, tableId = 24, name = "distance",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 3;
...
SET tableId = 25, name = "_tmpl_WCSSource",
	...
	INSERT INTO md_Column
	SET columnId = 344, tableId = 25, name = "sourceId",
		description = "Unique id.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 345, tableId = 25, name = "ampExposureId",
		description = "Pointer to Amplifier where source was measured.&#xA;If the Source belongs to multiple AmpExposures, then table Source2AmpExposure is used, and this pointer is NULL",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 346, tableId = 25, name = "filterId",
		description = "Pointer to an entry in Filter table: filter used to take Exposure where this Source (or these Sources) were measured.",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 347, tableId = 25, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 348, tableId = 25, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 349, tableId = 25, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 350, tableId = 25, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 351, tableId = 25, name = "raErrForDetection",
	...
	INSERT INTO md_Column
	SET columnId = 352, tableId = 25, name = "raErrForWcs",
	...
	INSERT INTO md_Column
	SET columnId = 353, tableId = 25, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 354, tableId = 25, name = "declErrForDetection",
	...
	INSERT INTO md_Column
	SET columnId = 355, tableId = 25, name = "declErrForWcs",
	...
	INSERT INTO md_Column
	SET columnId = 356, tableId = 25, name = "xFlux",
		description = "The flux weighted position for x, calculated from the first moment of the pixel values within the footprint",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 357, tableId = 25, name = "xFluxErr",
		description = "Uncertainty of the xFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 358, tableId = 25, name = "yFlux",
		description = "The flux weighted position for y, calculated from the first moment of the pixel values within the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 359, tableId = 25, name = "yFluxErr",
		description = "Uncertainty for yFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 16;
	...
	INSERT INTO md_Column
	SET columnId = 360, tableId = 25, name = "raFlux",
		description = "The flux weighted position for ra, calculated from the first moment of the pixel values within the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 17;
	...
	INSERT INTO md_Column
	SET columnId = 361, tableId = 25, name = "raFluxErr",
		description = "Uncertainty for raFlux",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 18;
	...
	INSERT INTO md_Column
	SET columnId = 362, tableId = 25, name = "declFlux",
		description = "The flux weighted position for decl, calculated from the first moment of the pixel values within the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 19;
	...
	INSERT INTO md_Column
	SET columnId = 363, tableId = 25, name = "declFluxErr",
		description = "Uncertainty for declFlux",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 20;
	...
	INSERT INTO md_Column
	SET columnId = 364, tableId = 25, name = "xPeak",
		description = "The position of the pixel (x) with the peak value in the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 21;
	...
	INSERT INTO md_Column
	SET columnId = 365, tableId = 25, name = "yPeak",
		description = "The position of the pixel (y) with the peak value in the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 22;
	...
	INSERT INTO md_Column
	SET columnId = 366, tableId = 25, name = "raPeak",
		description = "The position of the pixel (ra) with the peak value in the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 23;
	...
	INSERT INTO md_Column
	SET columnId = 367, tableId = 25, name = "declPeak",
		description = "The position of the pixel (decl) with the peak value in the footprint.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 24;
	...
	INSERT INTO md_Column
	SET columnId = 368, tableId = 25, name = "xAstrom",
		description = "The position (x) measured for purposes of astrometry.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 25;
	...
	INSERT INTO md_Column
	SET columnId = 369, tableId = 25, name = "xAstromErr",
		description = "Uncertainty for xAstrom",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 26;
	...
	INSERT INTO md_Column
	SET columnId = 370, tableId = 25, name = "yAstrom",
		description = "The position (y) measured for purposes of astrometry.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 27;
	...
	INSERT INTO md_Column
	SET columnId = 371, tableId = 25, name = "yAstromErr",
		description = "Uncertainty for yAstrom",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;
	...
	INSERT INTO md_Column
	SET columnId = 372, tableId = 25, name = "raAstrom",
		description = "The position (ra) measured for purposes of astrometry.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 29;
	...
	INSERT INTO md_Column
	SET columnId = 373, tableId = 25, name = "raAstromErr",
		description = "Uncertainty for raAstrom",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 30;
	...
	INSERT INTO md_Column
	SET columnId = 374, tableId = 25, name = "declAstrom",
		description = "The position (decl) measured for purposes of astrometry.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 31;
	...
	INSERT INTO md_Column
	SET columnId = 375, tableId = 25, name = "declAstromErr",
		description = "Uncertainty for declAstrom",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 32;
	...
	INSERT INTO md_Column
	SET columnId = 376, tableId = 25, name = "taiMidPoint",
		description = "If a DIASource corresponds to a single exposure, taiMidPoint represents tai time of the middle of exposure. For multiple exposures, this is middle of beginning-of-first-exposure to end-of-last-exposure",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 33;
	...
	INSERT INTO md_Column
	SET columnId = 377, tableId = 25, name = "taiRange",
		description = "If a DIASource corresponds to a single exposure, taiRange equals to exposure length. If DIASoure corresponds to multiple exposures, it taiRange equals to end-of-last-exposure minus beginning-of-first-exposure",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 34;
	...
	INSERT INTO md_Column
	SET columnId = 378, tableId = 25, name = "psfFlux",
		description = "PSF flux of the object.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 35;
	...
	INSERT INTO md_Column
	SET columnId = 379, tableId = 25, name = "psfFluxErr",
		description = "Uncertainty of psfFlux.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 36;
	...
	INSERT INTO md_Column
	SET columnId = 380, tableId = 25, name = "apFlux",
		description = "Aperture flux.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 37;
	...
	INSERT INTO md_Column
	SET columnId = 381, tableId = 25, name = "apFluxErr",
		description = "Uncertainty of apFlux.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 38;
	...
	INSERT INTO md_Column
	SET columnId = 382, tableId = 25, name = "modelFlux",
		description = "Adaptive 2D gauss model flux.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 39;
	...
	INSERT INTO md_Column
	SET columnId = 383, tableId = 25, name = "modelFluxErr",
		description = "Uncertainly of modelFlux.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 40;
	...
	INSERT INTO md_Column
	SET columnId = 384, tableId = 25, name = "petroFlux",
		description = "Petrosian flux.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 41;
	...
	INSERT INTO md_Column
	SET columnId = 385, tableId = 25, name = "petroFluxErr",
		description = "Uncertainty of petroFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 42;
	...
	INSERT INTO md_Column
	SET columnId = 386, tableId = 25, name = "instFlux",
		description = "Instrumental flux.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 43;
	...
	INSERT INTO md_Column
	SET columnId = 387, tableId = 25, name = "instFluxErr",
		description = "Uncertainty of instFlux.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 44;
	...
	INSERT INTO md_Column
	SET columnId = 388, tableId = 25, name = "nonGrayCorrFlux",
		description = "Instrumental flux corrected for non-gray extinction.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 45;
	...
	INSERT INTO md_Column
	SET columnId = 389, tableId = 25, name = "nonGrayCorrFluxErr",
		description = "Uncertainty of nonGrayCorrFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 46;
	...
	INSERT INTO md_Column
	SET columnId = 390, tableId = 25, name = "atmCorrFlux",
		description = "Instrumental flux corrected for both gray and non-gray extinction.",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 47;
	...
	INSERT INTO md_Column
	SET columnId = 391, tableId = 25, name = "atmCorrFluxErr",
		description = "Uncertainty of atmCorrFlux.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 48;
	...
	INSERT INTO md_Column
	SET columnId = 392, tableId = 25, name = "apDia",
		description = "Diameter of aperture (pixels)",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 49;
	...
	INSERT INTO md_Column
	SET columnId = 393, tableId = 25, name = "Ixx",
		description = "Adaptive second moment.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 50;
	...
	INSERT INTO md_Column
	SET columnId = 394, tableId = 25, name = "IxxErr",
	...
	INSERT INTO md_Column
	SET columnId = 395, tableId = 25, name = "Iyy",
		description = "Adaptive second moment.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 52;
	...
	INSERT INTO md_Column
	SET columnId = 396, tableId = 25, name = "IyyErr",
	...
	INSERT INTO md_Column
	SET columnId = 397, tableId = 25, name = "Ixy",
		description = "Adaptive second moment.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 54;
	...
	INSERT INTO md_Column
	SET columnId = 398, tableId = 25, name = "IxyErr",
		description = "Uncertainty of Ixy: sign(covariance(x, y))*sqrt(|covariance(x, y)|)",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 55;
	...
	INSERT INTO md_Column
	SET columnId = 399, tableId = 25, name = "snr",
		description = "Signal-to-Noise Ratio for the PSF optimal filter.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 56;
	...
	INSERT INTO md_Column
	SET columnId = 400, tableId = 25, name = "chi2",
		description = "Chi-square value for the PSF fit",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 57;
	...
	INSERT INTO md_Column
	SET columnId = 401, tableId = 25, name = "sky",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 58;

	INSERT INTO md_Column
	SET columnId = 402, tableId = 25, name = "skyErr",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 59;

	INSERT INTO md_Column
	SET columnId = 403, tableId = 25, name = "flagForAssociation",
	...
	INSERT INTO md_Column
	SET columnId = 404, tableId = 25, name = "flagForDetection",
		description = "FIXME: likely we should use a Stage name here",
		type = "SMALLINT",
		notNull = 0,
		displayOrder = 61;
	...
	INSERT INTO md_Column
	SET columnId = 405, tableId = 25, name = "flagForWcs",
...
SET tableId = 26, name = "_tmpl_mops_Ephemeris",
	...
	INSERT INTO md_Column
	SET columnId = 406, tableId = 26, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 407, tableId = 26, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 408, tableId = 26, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 409, tableId = 26, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 410, tableId = 26, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 411, tableId = 26, name = "smia",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 412, tableId = 26, name = "smaa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 413, tableId = 26, name = "pa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 414, tableId = 26, name = "mag",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 9;
...
SET tableId = 27, name = "_tmpl_mops_Prediction",
	...
	INSERT INTO md_Column
	SET columnId = 415, tableId = 27, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 416, tableId = 27, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 417, tableId = 27, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 418, tableId = 27, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 419, tableId = 27, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 420, tableId = 27, name = "smia",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 421, tableId = 27, name = "smaa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 422, tableId = 27, name = "pa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 423, tableId = 27, name = "mag",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 424, tableId = 27, name = "magErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
...
SET tableId = 28, name = "mops_Event";
	...
	INSERT INTO md_Column
	SET columnId = 425, tableId = 28, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 426, tableId = 28, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 427, tableId = 28, name = "eventType",
	...
	INSERT INTO md_Column
	SET columnId = 428, tableId = 28, name = "eventTime",
	...
	INSERT INTO md_Column
	SET columnId = 429, tableId = 28, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 430, tableId = 28, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 431, tableId = 28, name = "orbitCode",
	...
	INSERT INTO md_Column
	SET columnId = 432, tableId = 28, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 433, tableId = 28, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 434, tableId = 28, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 435, tableId = 28, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 436, tableId = 28, name = "ssmId",
...
SET tableId = 29, name = "mops_Event_OrbitDerivation",
	...
	INSERT INTO md_Column
	SET columnId = 437, tableId = 29, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 438, tableId = 29, name = "trackletId",
...
SET tableId = 30, name = "mops_Event_OrbitIdentification",
	...
	INSERT INTO md_Column
	SET columnId = 439, tableId = 30, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 440, tableId = 30, name = "childObjectId",
...
SET tableId = 31, name = "mops_Event_TrackletAttribution",
	...
	INSERT INTO md_Column
	SET columnId = 441, tableId = 31, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 442, tableId = 31, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 443, tableId = 31, name = "ephemerisDistance",
	...
	INSERT INTO md_Column
	SET columnId = 444, tableId = 31, name = "ephemerisUncertainty",
...
SET tableId = 32, name = "mops_Event_TrackletPrecovery",
	...
	INSERT INTO md_Column
	SET columnId = 445, tableId = 32, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 446, tableId = 32, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 447, tableId = 32, name = "ephemerisDistance",
		description = "Predicted position minus actual, arcsecs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 448, tableId = 32, name = "ephemerisUncertainty",
		description = "Predicted error ellipse semi-major axis, arcsecs",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 33, name = "mops_Event_TrackletRemoval",
	...
	INSERT INTO md_Column
	SET columnId = 449, tableId = 33, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 450, tableId = 33, name = "trackletId",
...
SET tableId = 34, name = "mops_MovingObjectToTracklet",
	...
	INSERT INTO md_Column
	SET columnId = 451, tableId = 34, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 452, tableId = 34, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 35, name = "mops_SSM",
	...
	INSERT INTO md_Column
	SET columnId = 453, tableId = 35, name = "ssmId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 454, tableId = 35, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 455, tableId = 35, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 456, tableId = 35, name = "e",
		description = "eccentricity e (dimensionless)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 457, tableId = 35, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 458, tableId = 35, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 459, tableId = 35, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 460, tableId = 35, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 461, tableId = 35, name = "epoch",
		description = "epoch of osculating elements, MJD (UTC)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 462, tableId = 35, name = "h_v",
		description = "Absolute magnitude",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 463, tableId = 35, name = "h_ss",
		description = "??",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 464, tableId = 35, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 465, tableId = 35, name = "albedo",
		description = "Albedo, dimensionless",
		type = "DOUBLE",
		notNull = 0,
		unit = "-",
	...
	INSERT INTO md_Column
	SET columnId = 466, tableId = 35, name = "ssmObjectName",
...
SET tableId = 36, name = "mops_SSMDesc",
	...
	INSERT INTO md_Column
	SET columnId = 467, tableId = 36, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 468, tableId = 36, name = "prefix",
	...
	INSERT INTO md_Column
	SET columnId = 469, tableId = 36, name = "description",
...
SET tableId = 37, name = "mops_Tracklet";
	...
	INSERT INTO md_Column
	SET columnId = 470, tableId = 37, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 471, tableId = 37, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 472, tableId = 37, name = "procHistoryId",
		description = "Pointer to processing history (prv_ProcHistory)",
		type = "INT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 473, tableId = 37, name = "ssmId",
		description = "Matching SSM ID for clean classifications",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 474, tableId = 37, name = "velRa",
	...
	INSERT INTO md_Column
	SET columnId = 475, tableId = 37, name = "velRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 476, tableId = 37, name = "velDecl",
	...
	INSERT INTO md_Column
	SET columnId = 477, tableId = 37, name = "velDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 478, tableId = 37, name = "velTot",
	...
	INSERT INTO md_Column
	SET columnId = 479, tableId = 37, name = "accRa",
	...
	INSERT INTO md_Column
	SET columnId = 480, tableId = 37, name = "accRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 481, tableId = 37, name = "accDecl",
	...
	INSERT INTO md_Column
	SET columnId = 482, tableId = 37, name = "accDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 483, tableId = 37, name = "extEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 484, tableId = 37, name = "extRa",
	...
	INSERT INTO md_Column
	SET columnId = 485, tableId = 37, name = "extRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 486, tableId = 37, name = "extDecl",
	...
	INSERT INTO md_Column
	SET columnId = 487, tableId = 37, name = "extDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 488, tableId = 37, name = "extMag",
	...
	INSERT INTO md_Column
	SET columnId = 489, tableId = 37, name = "extMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 490, tableId = 37, name = "probability",
	...
	INSERT INTO md_Column
	SET columnId = 491, tableId = 37, name = "status",
	...
	INSERT INTO md_Column
	SET columnId = 492, tableId = 37, name = "classification",
...
SET tableId = 38, name = "mops_TrackletsToDIASource",
	...
	INSERT INTO md_Column
	SET columnId = 493, tableId = 38, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 494, tableId = 38, name = "diaSourceId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 39, name = "prv_Filter",
	...
	INSERT INTO md_Column
	SET columnId = 495, tableId = 39, name = "filterId",
		description = "Unique id.",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 496, tableId = 39, name = "focalPlaneId",
	...
	INSERT INTO md_Column
	SET columnId = 497, tableId = 39, name = "name",
	...
	INSERT INTO md_Column
	SET columnId = 498, tableId = 39, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 499, tableId = 39, name = "clam",
	...
	INSERT INTO md_Column
	SET columnId = 500, tableId = 39, name = "bw",
...
SET tableId = 40, name = "prv_PolicyFile";
	...
	INSERT INTO md_Column
	SET columnId = 501, tableId = 40, name = "policyFileId",
	...
	INSERT INTO md_Column
	SET columnId = 502, tableId = 40, name = "pathName",
	...
	INSERT INTO md_Column
	SET columnId = 503, tableId = 40, name = "hashValue",
	...
	INSERT INTO md_Column
	SET columnId = 504, tableId = 40, name = "modifiedDate",
...
SET tableId = 41, name = "prv_PolicyKey";
	...
	INSERT INTO md_Column
	SET columnId = 505, tableId = 41, name = "policyKeyId",
	...
	INSERT INTO md_Column
	SET columnId = 506, tableId = 41, name = "policyFileId",
	...
	INSERT INTO md_Column
	SET columnId = 507, tableId = 41, name = "keyName",
	...
	INSERT INTO md_Column
	SET columnId = 508, tableId = 41, name = "keyType",
...
SET tableId = 42, name = "prv_Run";
	...
	INSERT INTO md_Column
	SET columnId = 509, tableId = 42, name = "offset",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 510, tableId = 42, name = "runId",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 43, name = "prv_SoftwarePackage";
	...
	INSERT INTO md_Column
	SET columnId = 511, tableId = 43, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 512, tableId = 43, name = "packageName",
		type = "VARCHAR(64)",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 44, name = "prv_cnf_PolicyKey";
	...
	INSERT INTO md_Column
	SET columnId = 513, tableId = 44, name = "policyKeyId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 514, tableId = 44, name = "value",
		type = "TEXT",
		notNull = 0,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 515, tableId = 44, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 516, tableId = 44, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 45, name = "prv_cnf_SoftwarePackage";
	...
	INSERT INTO md_Column
	SET columnId = 517, tableId = 45, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 518, tableId = 45, name = "version",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 519, tableId = 45, name = "directory",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 520, tableId = 45, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 521, tableId = 45, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 5;
...
SET tableId = 46, name = "sdqa_ImageStatus",
	...
	INSERT INTO md_Column
	SET columnId = 522, tableId = 46, name = "sdqa_imageStatusId",
		description = "Primary key",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 523, tableId = 46, name = "statusName",
	...
	INSERT INTO md_Column
	SET columnId = 524, tableId = 46, name = "definition",
...
SET tableId = 47, name = "sdqa_Metric",
	...
	INSERT INTO md_Column
	SET columnId = 525, tableId = 47, name = "sdqa_metricId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 526, tableId = 47, name = "metricName",
	...
	INSERT INTO md_Column
	SET columnId = 527, tableId = 47, name = "physicalUnits",
	...
	INSERT INTO md_Column
	SET columnId = 528, tableId = 47, name = "dataType",
	...
	INSERT INTO md_Column
	SET columnId = 529, tableId = 47, name = "definition",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 5;
...
SET tableId = 48, name = "sdqa_Rating_ForScienceAmpExposure",
	...
	INSERT INTO md_Column
	SET columnId = 530, tableId = 48, name = "sdqa_ratingId",
	...
	INSERT INTO md_Column
	SET columnId = 531, tableId = 48, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 532, tableId = 48, name = "sdqa_thresholdId",
	...
	INSERT INTO md_Column
	SET columnId = 533, tableId = 48, name = "ampExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 534, tableId = 48, name = "metricValue",
	...
	INSERT INTO md_Column
	SET columnId = 535, tableId = 48, name = "metricErr",
...
SET tableId = 49, name = "sdqa_Rating_ForScienceCCDExposure",
	...
	INSERT INTO md_Column
	SET columnId = 536, tableId = 49, name = "sdqa_ratingId",
		description = "Primary key. Auto-increment is used, we define a composite unique key, so potential duplicates will be captured.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 537, tableId = 49, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 538, tableId = 49, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 539, tableId = 49, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 540, tableId = 49, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 541, tableId = 49, name = "metricErr",
		description = "Uncertainty of the value of this metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
SET tableId = 50, name = "sdqa_Rating_ForScienceFPAExposure",
	...
	INSERT INTO md_Column
	SET columnId = 542, tableId = 50, name = "sdqa_ratingId",
		description = "Primary key. Auto-increment is used, we define a composite unique key, so potential duplicates will be captured.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 543, tableId = 50, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 544, tableId = 50, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 545, tableId = 50, name = "exposureId",
	...
	INSERT INTO md_Column
	SET columnId = 546, tableId = 50, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 547, tableId = 50, name = "metricErr",
		description = "Uncertainty of the value of this metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
SET tableId = 51, name = "sdqa_Threshold",
	...
	INSERT INTO md_Column
	SET columnId = 548, tableId = 51, name = "sdqa_thresholdId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 549, tableId = 51, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 550, tableId = 51, name = "upperThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 551, tableId = 51, name = "lowerThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 552, tableId = 51, name = "createdDate",
